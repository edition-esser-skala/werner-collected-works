...
B-XXVIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri --
  e e -- lei --
  son, e -- lei --
  son, e -- lei --
...
B-XXVIGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra, in
...
B-XXVICredoSopranoLyrics = \lyricmode {
  Pa -- trem o -- mni -- po --
  ten -- tem, fa -- cto -- rem
  coe -- li et ter --
  rae, vi -- si --
...
B-XXVISanctusSopranoLyrics = \lyricmode {
  San -- _ _
  _ _ ctus,
  san -- _ _
  _ ctus
...
B-XXVIBenedictusSopranoLyrics = \lyricmode {
  O -- san -- %19
  na in %20
  ex -- cel --
  sis, __ in __ ex --
...
B-XXVIAgnusSopranoLyrics = \lyricmode {
  A -- gnus De -- i, qui
