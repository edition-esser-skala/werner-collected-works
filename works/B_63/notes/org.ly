...
B-LXIIIKyrieOrgano = {
  \relative c {
    \clef bass
    \key f \lydian \time 3/2 \tempoB-LXIIIKyrie
    << {
      c'2. a4 d2
      h4 g s1
    } \\ {
    ...
    c1. \noBreak
    f,\fermata \bar "||" %20
    \clef "treble_8" \time 4/2 \tempoB-LXIIIChriste \newSpacingSection
...
B-LXIIIKyrieBassFigures = \figuremode {
  r1.
  r2 <6>1
  <6!>2 <5>1
  r1.
...
B-LXIIICredoOrgano = {
  \relative c {
    \clef bass
    \key f \lydian \time 4/2 \tempoB-LXIIICredo
      \set Staff.timeSignatureFraction = 2/2
    f\breve
    f1 r2 d
    a'2. g4 fis2 d
    ...
    g1 g,2 \noBreak
    c1 r2\fermata \bar "||"
    \clef treble \time 4/2 \tempoB-LXIIICrucifixus
      \set Staff.timeSignatureFraction = 2/2
      c'1-! es-! \noBreak
    fis-! << {
      g2 g~ %75
    ...
    f1. f,2 \noBreak
    c'\breve\fermata \bar "||"
    \clef treble \tempoB-LXIIIEtResurrexit
      c'1 \clef bass c, \noBreak
    e2 c g'1
    r2 f2. f4 e2 %95
    d1 c2 h
...
B-LXIIICredoBassFigures = \figuremode {
  <5 3>1 <6 4->
  <5 3>\breve
  <4>2 <_+> <[6]>1
  <_!> <6>
...
B-LXIIISanctusOrgano = {
  \relative c {
    \clef bass
    \key f \lydian \time 4/2 \tempoB-LXIIISanctus
      \set Staff.timeSignatureFraction = 2/2
    << {
      s1 c'~
      c4 h g2 a s
    ...
    c\breve~ \noBreak %20
    c1 f,\fermata \bar "||"
    \clef "treble_8" \tempoB-LXIIIOsanna c''1-! f,-! \noBreak
    g\trill f
    \clef bass << {
      r4 a2 h4 c d e d8[ e]
      f4 d a h c1 %25
...
B-LXIIISanctusBassFigures = \figuremode {
  r\breve
  r1. <5 3>4 <6!>
  <4> <3>2. <4>4 <_!>2.
  r2 <6!> <4> <5>
...
B-LXIIIBenedictusOrgano = {
  \relative c {
    \clef "treble_8"
    \key f \lydian \time 3/2 \tempoB-LXIIIBenedictus
    d'2. a4 f2
    cis d1
    a'2. g4 f e
    d2 g1
...
B-LXIIIBenedictusBassFigures = \figuremode {
  r2. <_+>4 <6>2
  <[6]> <9> <8>
  <4> <_+> <[6]>
  r <7 _-> <6 \t>
...
B-LXIIIAgnusOrgano = {
  \relative c {
    \clef bass
    \key f \lydian \time 4/2 \tempoB-LXIIIAgnus
      \set Staff.timeSignatureFraction = 2/2
    f1 d
    g e2 e
    a1 d,2 g!
...
B-LXIIIAgnusBassFigures = \figuremode {
  r1 <7 _+>
  <_->2 <_!> <7 _+>1
  r <7 _+>2 <_->
  <7[-]>1 <7>2 <6>
...
B-LXIIIFragmentOrgano = {
  \relative c {
    \clef bass
    \key f \lydian \time 4/2 \tempoB-LXIIIFragment
      \set Staff.timeSignatureFraction = 2/2
    << {
      s1 c'
      e2 d4 c h2 c
...
B-LXIIIFragmentBassFigures = \figuremode {
  r\breve
  r
  r1 <6>2 <3>
  r\breve*6 %9 finis
