...
B-LXIIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- %2
  e e -- lei --
  son, Ky -- ri --
  e, %5
...
B-LXIIICredoSopranoLyrics = \lyricmode {
  Pa --
  trem o -- mni -- po --
  ten -- tem, fa --
  cto -- rem coe --
...
B-LXIIISanctusSoprano = {
  \relative c' {
    ...
    c2. c4 c2 c \noBreak %20
    c1 c\fermata \bar "||"
    \tempoB-LXIIIOsanna R\breve*6 %27
    c1 g
    a\trill g
...
B-LXIIISanctusSopranoLyrics = \lyricmode {
  San -- _ _ %3
  _ ctus, san -- _ _
  _ ctus, %5
  san --
...
B-LXIIIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne --
  di -- _
  ctus, qui __
  _ ve --
...
B-LXIIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus
  De -- i, qui
  tol -- lis pec --
  ca -- ta mun --
