...
B-LXIIIKyrieBassoLyrics = \lyricmode {
  Ky -- ri --
  e e -- lei --
  son, Ky -- ri --
  e e -- lei --
...
B-LXIIICredoBassoLyrics = \lyricmode {
  Pa --
  trem o --
  mni -- po -- ten -- tem,
  fa -- cto -- rem
...
B-LXIIISanctusBassoLyrics = \lyricmode {
  San -- _ _
  _ ctus, san --
  ctus, san -- ctus,
  san -- ctus,
...
B-LXIIIAgnusBassoLyrics = \lyricmode {
  A -- gnus
  De -- i, qui
  tol -- lis pec --
  ca -- ta mun --
