...
B-XXXIIIKyrieViolinoI = {
  \relative c' {
    ...
    \tuplet 3/2 8 { a16 gis fis fis e d } h'4~ \tuplet 3/2 8 { h16 a gis gis fis e } cis'4~
    \tuplet 3/2 8 { cis16 h a a gis fis d'! cis h a gis fis } eis cis' \tuplet 3/2 8 { a gis fis \sbOff } cis8 \hA eis %15
...
B-XXXIIIGloriaViolinoI = {
  \relative c' {
    ...
    r32 e\fE fis gis a h cis d e cis d e fis gis a h cis16-! a-! e-! a-! e-! cis-! a-! e-!
    ...
    a a' fis d! h8 gis' a,16( cis) cis( d) e8 cis
    r16 fis\pE fis( g?) a8 fis r2
    r16 h, h( c) d h g d r a' fis'8 r16 g, e'8
    r4 r32 a, h cis d e fis g a16 \hA g32 a h16 \hA g fis \hA g32 fis \hA g16 e %20
    ...
    R1*2
    r16 a\f a d \tuplet 3/2 8 { \sbOn h a g g fis e a \hA g fis fis e d } \hA g8 g'~ \noBreak
    \tuplet 3/2 8 { g16 fis e } fis \hA g \sbOff \appoggiatura fis8 e8.\trill d16 d4 r\fermata \bar "||" %30
...
B-XXXIIICredoViolinoI = {
  \relative c' {
    ...
    a,2 r r
    R1.*9 %21
    r2 r4 d8\pE e fis4 gis
    a e a e d cis
    h( a) h h cis d
    e( cis) e gis, a h %25
    e,2 r4 cis' d e
    fis a8 gis fis4 e d cis
    ...
    \key a \minor \time 4/4 \tempoB-XXXIIIEtIncarnatus \newSpacingSection
      r8 e4\fE e8 r h'4 h8 \noBreak
    r c,4 c8 r h4 e8
    c a4 a8 gis h4 c16 d
    e8 g!4 g8 r g,4 g8
    r a4 a8 r a4 e'8 %50
    dis dis e4. \hA dis16 cis \hA dis4\trill
    e8 h4 cis8 d d r4
    r8 c4 c8 h e4 e8
...
B-XXXIIIBenedictusViolinoI = {
  \relative c' {
    ...
    e(\p h) h( cis) \appoggiatura h8 a8.\trill gis32 fis gis4 r\fermata \markOsannaUtSupra \bar "||" %9 finis
  }
}
...
B-XXXIIIAgnusViolinoI = {
  \relative c' {
    ...
    cis4 r r8 e\fE cis' e,
    d h fis d r fis' dis' fis,
    eis cis gis eis16 gis cis8 gis'16 \hA eis cis8 gis
    ...
    \time 6/8 \tempoB-XXXIIIDona \newSpacingSection \tightNotes
      R2. \noBreak
    h16\fE d32 cis h8 h cis16 h a h cis d
    ...
    e4 r8 r4 r8
    fis16 a32 gis fis8 fis gis32 e fis gis a h cis d! e16 d
    cis e32 d cis8 cis cis16 e32 d cis8 cis %30
    h16 d32 cis h8 h cis64 a h cis d e fis gis a16 e cis a
    r4 r8 r64 e fis gis a h cis d e16 h gis e
    r4 r8 \sbOn r16 h'\p \tuplet 3/2 8 { h a h his ais? \hA his } \sbOff
    cis4 r8 r64 cis,\f dis eis fis gis ais his? cis16 gis \hA eis cis
