...
B-XXXIIICredoOrgano = {
  \relative c {
    ...
    a a' fis! d a a a a \noBreak %110
    d2 r\fermata \bar "||"
    \tempoB-XXXIIIEtVitam \mvTr g4-!\fE-\tuttiE a8-! g16-! fis-! g8 g a g16 fis \noBreak
    g a g fis e4\trill << {
      d' e8 d16 cis
...
B-XXXIIISanctusOrgano = {
  \relative c {
    ...
    cis a fis d a'2
    d,4 r r2
    r \tempoB-XXXIIIPleni r8 d'-\unisonoE fis a
...
B-XXXIIIBenedictusOrgano = {
  \relative c {
    ...
    \clef "treble_8" \key d \major \time 3/2 \tempoB-XXXIIIOsanna \newSpacingSection
      \mvTr g'2-!\fE-\tutti a1-! \noBreak
    g2-! c1-!
    h2-! e1-!
    << {
