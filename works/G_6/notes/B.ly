...
G-VIBasso = {
  \relative c {
    ...
    R1*3
    \mvTr b'8.\fE^\tutti b16 b8 f g g r d
    es es r b c c a b %5
    f'4 r8 b a f r b\p
    a f r f\f b b g([ b)]
    c4 r8 a, d b e c
    ...
    c'( c,) f, r
    R1*10 %32
    \mvTr b'4\fE^\tutti b8 f b b b f
    b,8. b16 b4 es8 es c c
    f8. f16 d8 d g es a f %35
    b b, r f' b4 r8 f
    d es f4 b, r \noBreak
    R1\fermata \bar "||"
    ...
    f b, f' b \noBreak %125
    f2 b,\fermata \bar "||"
    \tempoG-VId \mvTr g'4\pE^\solo b a d, \noBreak
    b' g8 es! cis4. cis8
    d4 d r b'
    c8. f,16 f4 es'8([ c)] a([ es)] %130
    d4 d8 b' as4 h,
    c c8 es' cis,2
    d4 r d'4. d,8
    b'4 g, f'!8([ a)] c([ es)]
    d([ f,)] b, b' d,4 r8 b' %135
    es,4 f g2
    f4 r8 f a8. a16 a4
    b b,8 as' g4( h,)
    c es' cis, cis
    ...
    r2 \mvTr a'4.\pE^\solo h8
    c g g a b2~ %190
    b8 e, f d' c,4. c8
    f,4 r r2
    R1
    r2 r4 f'
    d g8 g c8.([ b!16)] a8 g %195
    fis4 g8 c, d4. d8
    g,4 \mvTr a'8\fE^\tutti f! b4 b8 f
    g4 g8 d es b f'([ g)]
    f4 r r2
    r4 b,8 b c4 d %200
    es8. d16 c8 b a!4 b
...
G-VIBassoLyrics = \lyricmode {
  ...
  Par -- ce %189
  no -- bis, par -- ce, par -- %190
  ce no -- bis, Do -- mi --
  ne.

  Ex --
  au -- di, ex -- au -- di, ex -- %195
  au -- di nos, Do -- mi --
  ne. A -- gnus De -- i, qui
