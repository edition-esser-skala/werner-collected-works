...
G-VISoprano = {
  \relative c' {
    ...
    R1*3
    \mvTr d'8.\fE^\tutti d16 d8 f d d r d
    b b r d c c c b %5
    a4 r8 b c c r d\p
    c a f'4\f d8 d g4
    e r8 c a d c8. c16
    ...
    d r r2
    R1*8 %26
    b8^\aTre b d a b8. b16 b4
    c8 a a([ c)] f,4 f'~
    f8 b, es4. a,8 d4~
    d8 c c b a16[ b a b] c4~ %30
    c8 b16([ a)] b4. b8 a b
    a4( g)\trill f r
    \mvTr d'\fE^\tutti d8 f d d d c
    d8. d16 d4 b8 b es es
    c8. c16 d8 d b es c f %35
    d d r c d4 r8 c
    d c c4 d r \noBreak
    R1\fermata \bar "||"
