...
B-LXIVKyrieTromboneII = {
  \relative c' {
    ...
    f8 c f e16 d c4. a8
    g \once \tieDashed c~ c16 b a g f8 e d4
    c2 r4 r8 f'~ %5
...
B-LXIVQuiTollisTromboneII = {
  \relative c' {
    ...
    b4. c8 b g es' d16 c
    b8 c d4 g, a8 b
    c2 c\fermata \bar "||" %89 finis
  }
}

B-LXIVCumSanctoTromboneII = {
  \relative c' {
    \clef tenor
...
B-LXIVEtResurrexitTromboneII = {
  \relative c' {
    ...
    c8 d e f g4 \noBreak
    f f r
    \time 4/4 \tempoB-LXIVEtMortuos c2\pE c4. c8 \noBreak
    h1\fermata
