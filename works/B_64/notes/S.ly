...
B-LXIVKyrieSoprano = {
  \relative c' {
    ...
    g r r
    R1.*3
    \tempoB-LXIVChristeB r4 a b a2 g4 %40
    a1.\fermata \markKyrieUtSupra \bar "||" %41 finis
  }
}

B-LXIVKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e __ e -- %2
  lei -- son, e -- lei --
  son,
  Ky -- ri -- e e -- lei -- %5
...
B-LXIVGloriaSoprano = {
  \relative c' {
    ...
    \time 3/2 \tempoB-LXIVLaudamus a2 r r \noBreak %5
    R1.*5 %10
...
B-LXIVGloriaSopranoLyrics = \lyricmode {
...
B-LXIVQuiTollisSopranoLyrics = \lyricmode {
  Pec -- %82
  ca -- ta
  mun -- di:
  Mi -- se -- %85
...
B-LXIVQuoniamSoprano = {
  \relative c' {
    \clef treble
    \key f \major \time 3/2 \autoBeamOff \tempoB-LXIVQuoniam
...
B-LXIVQuoniamSopranoLyrics = \lyricmode {
...
B-LXIVCumSanctoSopranoLyrics = \lyricmode {
  Cum %149
  San -- cto Spi -- ri -- %150
  tu __ in glo -- ri --
  a __ De -- i
...
B-LXIVCredoSopranoLyrics = \lyricmode {
  Et in %12
  u --
  num Do -- mi --
  num Je -- sum %15
...
B-LXIVCrucifixusSopranoLyrics = \lyricmode {
  Cru -- ci -- %103
  fi -- xus
  e -- ti -- am pro %105
  no -- bis,
...
B-LXIVEtResurrexitSoprano = {
  \relative c' {
    ...
    g g r \noBreak
    a a r
    \time 4/4 \tempoB-LXIVEtMortuos a,2\p g4. g8 \noBreak
    g1\fermata
    \time 3/4 \tempoB-LXIVCuiusRegni r4 d'\fE d \noBreak %240
    e e r
    r d8([ c)] d([ h)]
    e4 e r8 c
    a4 a r8 d
...
B-LXIVEtResurrexitSopranoLyrics = \lyricmode {
  Et re -- sur -- %210
  re -- xit
...
B-LXIVEtInSpiritumSopranoLyrics = \lyricmode {
  Qui ex %250
...
B-LXIVEtVitamSopranoLyrics = \lyricmode {
  Et %273
  vi -- tam ven --
  tu -- ri sae -- cu -- %275
  li, a --
...
B-LXIVSanctusSopranoLyrics = \lyricmode {
  San -- %3
  ctus, san -- ctus,
  san -- ctus Do -- %5
  mi -- nus, Do --
...
B-LXIVBenedictusSopranoLyrics = \lyricmode {
  Be -- ne --
  di -- ctus,
  be -- ne --
  di -- ctus, qui __
...
B-LXIVAgnusSoprano = {
  \relative c' {
    ...
    R1*8 %8
    r2 \mvDl c'4.\fE^\tutti c8
    g' c, b!8. a16 a4 a8 a %10
    f'4 f8 f d4 d8 f
    b,2. a4 \noBreak
    g2 g\fermata \bar "||"
    \tempoB-LXIVDona R1*5 %18
    \mvTr a4.\pE^\solo b16([ g)] a8 f16([ g)] a8 b16([ g)]
    a8 f16([ g)] a8. a16 d8 c c([ h)] %20
    c4 r r2
    R1*2
    \mvTr c4.\fE^\tutti d16([ b)] c8 a16([ b)] c8 d16([ b)]
    ...
    a4 b g4 a8 d~
    d cis a4 a r
    r8 a4 a8 h c c([ \hA h)] %35
    c4 r r a8 b16([ c)]
    d8 c c([ b)] a4 b8 c
    b g16([ a)] b8 c b g16([ a)] b8 b
    b a g4 a8^\critnote b4\p c16([ a)]
    b8 g16([ a)] b8 c16([ a)] b8 g16([ a)] b8 b %40
    b a g4 a r\fermata \bar "|." %41 finis
  }
}

B-LXIVAgnusSopranoLyrics = \lyricmode {
  A -- gnus %9
  De -- i, A -- gnus De -- i, qui %10
  tol -- lis pec -- ca -- ta, pec --
  ca -- ta
  mun -- di:

  Do -- na no -- bis pa -- cem, %19
  pa -- cem, do -- na no -- bis pa -- %20
  cem.

  Do -- na no -- bis pa -- cem, %24
  pa -- cem, do -- na no -- bis pa -- %25
  _ cem, do -- na
  no -- bis, do --
  na,
  do -- na no -- bis pa -- cem,
