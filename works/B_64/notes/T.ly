...
B-LXIVKyrieTenore = {
  \relative c' {
    ...
    \key d \minor \time 3/2 \tempoB-LXIVChriste \newSpacingSection
      R1.*22 %39
    \tempoB-LXIVChristeB R1. %40
    R\fermata \markKyrieUtSupra \bar "||" %41 finis
  }
}

B-LXIVKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- e __ e --
  lei -- son, e -- lei --
  son, e -- lei -- son, e --
  lei -- _ _
...
B-LXIVGloriaTenore = {
  \relative c' {
    ...
    c8 b a_([ g16 f] g4 c)
    \time 3/2 \tempoB-LXIVLaudamus c2 r r \noBreak %5
    R1.*30 %35
...
B-LXIVGloriaTenoreLyrics = \lyricmode {
  Et in
  ter -- ra pax, pax ho --
...
B-LXIVDomineDeusTenoreLyrics = \lyricmode {
  Do -- mi -- ne Fi -- li, %66
...
B-LXIVQuiTollisTenoreLyrics = \lyricmode {
  Qui %82
  tol --
  lis pec -- ca -- ta
  mun -- di: Mi -- se -- %85
...
B-LXIVCumSanctoTenoreLyrics = \lyricmode {
  Cum San -- cto %141
  Spi -- ri -- tu __ in
  glo -- ri -- a __ De --
  i Pa --
...
B-LXIVCredoTenoreLyrics = \lyricmode {
  Et in %13
  u --
  num Do -- mi -- %15
  num Je -- sum
...
B-LXIVQuiPropterTenoreLyrics = \lyricmode {
  Qui pro -- pter nos %83
  ho -- mi -- nes et
...
B-LXIVCrucifixusTenoreLyrics = \lyricmode {
  Cru -- ci -- %106
  fi -- xus
  e -- ti -- am pro
  no -- bis,
...
B-LXIVEtResurrexitTenore = {
  \relative c' {
    ...
    c8 d e([ f)] g4 \noBreak
    f f r
    \time 4/4 \tempoB-LXIVEtMortuos c2\p c4. c8 \noBreak
    h1\fermata
    \time 3/4 \tempoB-LXIVCuiusRegni r4 d\fE h \noBreak %240
    c c r
    r d d
    c c8 c c4
    c r8 d a4
...
B-LXIVEtResurrexitTenoreLyrics = \lyricmode {
  Et re -- sur -- %210
  re -- xit
...
B-LXIVEtInSpiritumTenoreLyrics = \lyricmode {
  Et vi -- vi -- fi -- can -- %251
  tem,
...
B-LXIVEtVitamTenoreLyrics = \lyricmode {
  Et %269
  vi -- tam ven -- %270
  tu -- ri sae -- cu --
  li, a -- _ _
...
B-LXIVSanctusTenoreLyrics = \lyricmode {
  San -- ctus, %2
  san --
  ctus, san --
  _ ctus %5
...
B-LXIVBenedictusTenoreLyrics = \lyricmode {
  Be -- ne -- %2
  di -- ctus,
  be -- ne --
  di -- %5
...
B-LXIVAgnusTenore = {
  \relative c' {
    ...
    R1*8 %8
    r2 \mvDl e4.\fE^\tutti e8
    e4 e8 e e([ cis)] a4 %10
    r r8 d d([ b)] b c
    d4 d c2 \noBreak
    c1\fermata \bar "||"
    \tempoB-LXIVDona
      \mvTr c4.\pE^\solo d16([ b)] c8 a16([ b)] c8 d16([ b)] \noBreak
    c8 a16([ b)] c8 d16([ e)] f8 e d[ c]~ %15
    c[ h16 a] \appoggiatura c8 \hA h4\trill c r
    R1*4 %20
    c4. c8 c2~
    c4. b!8 a d g, f
    e f b d c f, c4
    f8 \mvTr a4\fE^\tuttiE b16([ g)] a8 f16([ g)] a8 b16([ g)]
    a8 f r4 r2 %25
...
B-LXIVAgnusTenoreLyrics = \lyricmode {
  A -- gnus %9
  De -- i, qui tol -- lis, %10
  qui tol -- lis pec --
  ca -- ta mun --
  ...
  cem, do -- na no -- bis pa -- cem,
  do -- na no -- bis pa -- cem, %35
  do -- na no -- bis pa -- cem, do -- na
  pa -- cem, do -- na
  no -- bis pa -- cem, pa -- cem, no -- bis
  pa -- cem, pa -- cem, do -- na
  no -- bis pa -- cem, pa -- cem, do -- na %40
