...
B-LXIVKyrieOrgano = {
  \relative c {
    ...
    e2. d4 cis2
    d2. c4 b2
    \tempoB-LXIVChristeB a d4 c! b2 %40
    a1.\fermata \markKyrieUtSupra \bar "||" %41 finis
  }
}

B-LXIVKyrieBassFigures = \figuremode {
  r1
  r
  <4>4 <3>8 <6> q q q4
  \bo <[5 2]> \bc <[6 _]>2.
...
B-LXIVGloriaOrgano = {
  \relative c {
    ...
    c2 c
    \time 3/2 \tempoB-LXIVLaudamus f,2 d'-\solo e \noBreak %5
    f a, b
    c4 d e f e d
    c d e f e d
    c2 r r
...
B-LXIVGloriaBassFigures = \figuremode {
  r1
  <7>4 <6> <_+>2
  r4 <6- _+>8 \bo <[6]> r2
  \bc <[5] 3>4 <6 4> <5 \t> <\t 3>
...
B-LXIVDomineDeusOrgano = {
  \relative c {
    \clef bass
    \key d \minor \time 4/4 \tempoB-LXIVDomineDeus
...
B-LXIVDomineDeusBassFigures = \figuremode {
  r4 \bo <[6]>2 \bc q4 %50
...
B-LXIVQuiTollisBassFigures = \figuremode {
  r1 %82
  <6 4->4 <6 5-> <9> <8>
  <4> <3>2.
  r8 <7- 5>4. <5 4>4 <\t 3> %85
...
B-LXIVQuoniamBassFigures = \figuremode {
  r1. %100
  <5 4>2 <\t 3>2. <7>4
  <4>2 <3> <6>4 <5->
  <9> <8>2. <6>4 <5>
...
B-LXIVCumSanctoBassFigures = \figuremode {
  r1
  r
  r
  r
...
B-LXIVCredoBassFigures = \figuremode {
  r2 <[6]>4
  r2 <6>4
  r2 <6\\>4
  r <6>2
...
B-LXIVQuiPropterBassFigures = \figuremode {
  <_+>1 %83
  <7 5>2 <5 _+>4 <6! _!>
  <_->2 <7[-] _!> %85
  <6>1
...
B-LXIVCrucifixusOrgano = {
  \relative c {
    ...
    r e e e e e \noBreak
    e1 r2\fermata \bar "||"
    \clef "treble_8" \key a \minor \time 2/2 \tempoB-LXIVSubPontio \newSpacingSection
    << {
      R1 %120
      r2 a'~
      a gis
...
B-LXIVCrucifixusBassFigures = \figuremode {
  r1. %103
  r4 <6\\> r1
  r4 <_ _+>2. <7[!] \t>2 %105
  r4 <_ _!>2. <7[!] \t>2
...
B-LXIVEtResurrexitOrgano = {
  \relative c {
    ...
    e4. d8 e c \noBreak
    f4 f^\critnote r
    \time 4/4 \tempoB-LXIVEtMortuos f2\p c4. c8 \noBreak
    g1\fermata
    \time 3/4 \tempoB-LXIVCuiusRegni g'8\fE a h a h g \noBreak %240
    << { c4 } \\ { c, } >> r8 d e f
    g4 r8 a h g
    c4 r8 c, d e
    f4. d8 e f
...
B-LXIVEtResurrexitBassFigures = \figuremode {
  r2. %202
  \bo <[6]>
  r
  \bc q %205
...
B-LXIVEtInSpiritumBassFigures = \figuremode {
  r2 <_+> %250
...
B-LXIVEtVitamBassFigures = \figuremode {
  r %267
  r
  r
  r %270
...
B-LXIVSanctusOrgano = {
  \relative c {
    ...
    \mvTr f'2.\fE-\tutti e4
    d \clef "treble_8" b2 \clef bass f4~
    f e d2~
    d4 d e2~
    e a, %5
    fis' g
    ...
    b c2. b4
    a b c1
    f, \clef "treble_8" d''4 c %50
    b a g2 \clef bass c,~
    c f2. e4
    d2. c4 h2
    c g'1
    c, \clef "treble_8" << { e'2 } \\ { a, } >> %55
    \clef bass f1 d2~
    d g es~
    es4 d es2 c~
    c f2. es4
...
B-LXIVSanctusBassFigures = \figuremode {
  <5 3>2 <4 2>4 <6>
  <5> \bo <[3]> \bc <[2]>2
  <6 4 2>4 <6> <7 _+> <6 4>
  <8 _+> <7 \t> <5[!] _+> <6 4>
...
B-LXIVBenedictusBassFigures = \figuremode {
  r4 <6> <[6]>
  r2 <_+>4
  <6>2 <6!>4
  <6>2 q4
...
B-LXIVAgnusOrgano = {
  \relative c {
    ...
    d c
    h4 ais h2
    e4. d!8 \mvTr c2\fE-\tuttiE
    c cis %10
    d4 r8 d b'4 b8 a
    g4. f8 e4 f \noBreak
    c1\fermata \bar "||"
    \tempoB-LXIVDona \mvTr f,8\pE-\solo f'16 g a8 b a f r b \noBreak
    a f r b a g f e %15
    d f g g, c, c'16 d e8 f
    e c r f e c r b'!
    a g f e d b g a
    d d' d d, r d' d d,
    r d' d c h c g4 %20
    c,8 c' c f, r c' c f,
    \clef "treble_8" c'4. b!8 a d g, f
    e f b d c f, c4
    \clef bass \mvTr f,8\fE-\tutti f' f b, r f' f b,
    f4 \clef treble << { c'''8 d16 e f8 e d16 e f8 } \\ { r4 f,8 g16 a b8 a } >> %25
    \clef "treble_8" c,4. d16 e \clef bass f,8 g16 a b8 a
    g f e f c c' c f,
    r c' c f, c4 \clef "treble_8" d'8-! d-!
    d-! \clef bass d,[ d g] r d d g,
    d'4 \clef treble e'8-! e-! e-! \clef bass e,[ e a,] %30
    r e' e a, e4 \clef treble << {
      e'''8 d
      c16 d e8 d c h16 c d8
    } \\ {
      r4 a8 g! f!16 g a8 g[ f]
    } >> \clef bass a,8 g
    f16 g a8 g f e16 f g8 f d
    a'1~-\tasto
    a4. d,8 g, c! g4 %35
    << { g'8^\critnote a16 b! c8 b } \\ { c,4 c8 d16 e } >> f8 e d c
    b a g4 d' g8 c,
    g'4. c,8 g'4. f!8
    e! f c4 f, r
    R1 %40
...
B-LXIVAgnusBassFigures = \figuremode {
  r1
  <7 4 2>2 <8 5 3>
  <7-> <6>
  r <7 [5!] _+>
  <7 5 [_+]> \bo <[5!] 4>4 \bc <[\t] _+> %5
  r2 <6>4 <5[!]>
  <[_!]>2 <4\+ 2\+>
  <7 [5\+] _+>4 <7 5 [_+]> \bo <[5\+] 4>4 \bc <[\t] _+>
  r4. <6!>8 r2
  <8>4 <7-> <6>2 %10
  r <5>4. <[6 _!]>8
  r2 <6 5>
  <5 4>4 \bassFigureExtendersOn <5 3>8 <5 2> <5 3>2 \bassFigureExtendersOff
  r2 <[6]>
  \bc q <6>8 q q q %15
  <7>4 <4>8 <_!> r2
  \bo <[6]> <6>4. \bc <[2]>8
