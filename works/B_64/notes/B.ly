...
B-LXIVKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e __ e -- %3
  lei -- son, e -- lei --
  son, %5
  Ky -- ri -- e __ e --
...
B-LXIVGloriaBasso = {
  \relative c {
    ...
    c4 c c2
    \time 3/2 \tempoB-LXIVLaudamus f,2 r r \noBreak %5
    R1.*30 %35
...
B-LXIVGloriaBassoLyrics = \lyricmode {
  Et in
  ter -- ra pax,
...
B-LXIVDomineDeusBassoLyrics = \lyricmode {
  Do -- mi -- ne De -- us, %73
...
B-LXIVQuiTollisBassoLyrics = \lyricmode {
  Qui tol -- %82
  lis, tol --
  lis:
  Mi -- se -- re -- re %85
...
B-LXIVCumSanctoBassoLyrics = \lyricmode {
  Cum %145
  San -- cto Spi -- ri --
  tu __ in glo -- ri --
  a __ De -- i
...
B-LXIVCredoBassoLyrics = \lyricmode {
  Et ex %21
  Pa -- tre
  na -- tum,
  et ex
...
B-LXIVQuiPropterBassoLyrics = \lyricmode {
...
B-LXIVCrucifixusBassoLyrics = \lyricmode {
  Cru -- ci -- %105
  fi -- xus
  e -- ti -- am pro
  no -- bis,
...
B-LXIVEtResurrexitBasso = {
  \relative c {
    ...
    e[ d c d] e([ c]) \noBreak
    f4 f, r
    \time 4/4 \tempoB-LXIVEtMortuos f2\pE c4. c8 \noBreak
    g1\fermata
    \time 3/4 \tempoB-LXIVCuiusRegni r4 h'\fE g \noBreak %240
    c c, r
    r h'8([ a)] \hA h([ g)]
    c4 c, r8 e
    f4 f r8 f
...
B-LXIVEtResurrexitBassoLyrics = \lyricmode {
  Et re -- sur -- %210
  re -- xit
...
B-LXIVEtInSpiritumBassoLyrics = \lyricmode {
  Qui cum %251
  Pa -- tre et Fi -- li -- o
  si -- mul ad -- o -- ra --
  tur,
...
B-LXIVEtVitamBassoLyrics = \lyricmode {
  Et vi -- %267
  tam ven -- tu -- ri
  sae -- cu -- li,
  a -- _ _ %270
...
B-LXIVSanctusBassoLyrics = \lyricmode {
  San -- %2
  ctus, san --
  ctus, san --
  ctus %5
...
B-LXIVAgnusBassoLyrics = \lyricmode {
  A -- gnus De -- i, qui
  tol -- lis pec -- ca -- ta,
  pec -- ca -- ta mun -- di:
  Mi -- se -- re -- re, mi -- se --
