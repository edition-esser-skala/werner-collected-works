...
Z-IX-VViolinoI = {
  \relative c' {
    ...
    g a f g es f d es c c' b c a b g a %40
    f g es f d es c d b b' a b g a f g
    es f d es c d b c a8 f' d g
    d4 c\trill b b'~\f
    b8 a c4. b8 d4~
    d8 c es16 d es8 f,16 f' es f d es c d %45
    ...
    r8 c d4 r8 h cis4
    r8 d f,4. f8 f f
    e8. cis'16\f d8 e f8. f16 g8 a %55
...
Z-IX-VIViolinoI = {
  \relative c' {
    ...
    d8 d, r a'' h,4. c16( h)
    c8 g g' es cis4. d16( cis) %5
    d4.\p c8 b4 cis,
    d2 r\fermata
    es'!\f r8 g es c
    b2 r8 e cis b!
    a2 r8 a' fis es %10
    d4 g2 \once \tieDashed f4~
    f2 e4 es
    d2 cis4 d
    e2~ e8 e d c
    b4 b'4. b8 a g %15
    fis4 r8 fis g g,\p g16( fis) g8
