...
Z-IX-IViola = {
  \relative c' {
    ...
    d4 r8 d\pp d d \noBreak %30
    c2 r4\fermata \bar "||"
    \time 4/4 \tempoZ-IX-Ib r8 f\fE a d h a16 h c8 c, \noBreak
...
Z-IX-VViola = {
  \relative c' {
    ...
    b, e a, d d,4 b' \noBreak
    e,2 r\fermata \bar "||"
    \tempoZ-IX-Vb r8 d'\fE f d e4. cis8 \noBreak %20
    a4 r r2
    R1*3
    r2 r8 c a a'~ %25
    a gis h, h'~ h a c, c'~
