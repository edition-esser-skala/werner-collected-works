...
Z-IX-IViolinoII = {
  \relative c' {
    \clef treble
    \key d \minor \time 3/4 \zempoZ-IX-Ia
    r8 f'\fE f f, f4
    r8 g' g g, g4
    r8 a' a a, b a
    a( g) g4 r
    ...
    \zempoZ-IX-Ic f4\fermata r as,2~
...
Z-IX-IIViolinoII = {
  \relative c' {
    \clef treble
    \key d \minor \time 3/4 \zempoZ-IX-IIa f4\f r r
    a\p r r
    d\f r r
    b\p r r
    cis\f r r %5
...
Z-IX-VViolinoII = {
  \relative c' {
    ...
    b c a b g a f g es es' d es c d b c
    ...
    r8 a f4 r8 g e4
    r8 f d4~ d8 d d d
    cis8. cis'16\fE d8 e f8. f16 g8 a %55
    b,8. b16 c8 d e8. e16 f8 g
    a,8. a16 b8 c d8. d16 e8 f
    g e d2 cis4\trill
    d r8 d,\p e4 r8 c
    d4 r8 g cis,4 \zempoZ-IX-Vc d~ %60
    d d2 cis4
...
Z-IX-VIViolinoII = {
  \relative c' {
    ...
    d8 c b a g b a g \noBreak %20
    fis2 r\fermata \bar "||"
    \time 3/4 \zempoZ-IX-VIb d'4 es r8 cis \noBreak
    d16 cis d8 r h c? b16( a)
    b8 h c cis d d,
    g b'16 a g8 g16 f e8 d~ %25
    d cis d16 cis d8 h cis
    d16 e d c h8 e16 d cis a a' g
    fis8 e16 fis g8 g, c es
