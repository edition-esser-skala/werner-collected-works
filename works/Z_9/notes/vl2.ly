...
Z-IX-IViolinoII = {
  \relative c' {
    \clef treble
    \key d \minor \time 3/4 \tempoZ-IX-Ia
    r8 f'\fE f f, f4
    r8 g' g g, g4
    r8 a' a a, b a
    a( g) g4 r
...
Z-IX-IIViolinoII = {
  \relative c' {
    \clef treble
    \key d \minor \time 3/4 \tempoZ-IX-IIa f4\f r r
    a\p r r
    d\f r r
    b\p r r
    cis\f r r %5
...
Z-IX-VViolinoII = {
  \relative c' {
    ...
    g e d2 cis4\trill
    d r8 d,\p e4 r8 c
    d4 r8 g cis,4 \tempoZ-IX-Vc d~ %60
    d d2 cis4
...
Z-IX-VIViolinoII = {
  \relative c' {
    ...
    d8 c b a g b a g \noBreak %20
    fis2 r\fermata \bar "||"
    \time 3/4 \tempoZ-IX-VIb d'4 es r8 cis \noBreak
