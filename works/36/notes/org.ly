...
XXXVIOrgano = {
  \relative c {
    ...
    f d g e a f h g \noBreak
    c c, r4 r2
    \tempoXXXVIb c4-\markup \remark "con pedale" r f r \noBreak
    <g g,>1~
    q4 r r2 %15
    c,4 r r2
    f,8 f' f f d d h h
    g4 r r r8 g-\markup \remark "con pedale" \noBreak
    c g es c \tempoXXXVIc g'4 r8 h \noBreak
    c c, r e'! f f, r d' %20
    g g, r16 g' h g c8 h16 a g f e d
    c8 f g g, c4 r \noBreak
    c r c r\fermata \bar "||"
    \tempoXXXVId \mvTr a2\pE-\soloE e' \noBreak
    fis dis %25
    d h
