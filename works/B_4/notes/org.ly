...
B-IVCredoOrgano = {
  \relative c {
    ...
    c, c' g c e, g %10
    c, f g f g g,
    c e \mvTr a\pE-\solo ^\mvTz^\aDue e c a
    e' h' e h gis e
    a, e' a e cis a
    d a' d a f d %15
    g, d' g d h g
    ...
    d4. e8 fis4 %55
    g g,8 a h4
    c e \clef "treble_8" \once \tieDashed c'~
    c h b~
    b a as
    g c, c'~ %60
    c h8 a \clef bass g4~
    ...
    \key a \minor \time 4/4 \tempoB-IVEtIncarnatus
      \mvTr a'4.\fE-\solo g8 f4. dis8 \noBreak
    e4 r8 gis a4 h
    c4. b8 a4 r8 cis, %75
    d4. c8 h4 r8 dis
    e4 fis8 gis a4 d,
    g r8 c, f4 r8 h,
    e4 r8 e f e16 d c8 d
    e1 %80
    a,4 r r8 a'\pE a a
    gis4 r r8 g g g
    f4 r r8 dis dis dis
    e4 r r8 d cis c
    h4 r r8 ais ais ais %85
    h4 r r8 e e e
    a4 r r8 d, d d
    g4. fis8 e4. d8
    c4. h8 a4 f'8 dis
    e2. e,4 %90
    << { a'4. } \\ { a,4\fE } >> g'8 fis4. h8
    e,4. a8 d,2~
    d4 c8 d e4 e,
    a a'8\pE c f,2
    e d4. d8 %95
    ...
    g g g g g g
    g4 r r
    r8 c'16 h c8 g e g %115
    c, c'16 h c8 g e g
    c, c'16 h c8 g e g
    c4 c, r
    a'8 c16 h a8 e c e
    a, c'16 h a8 e c a %120
    fis' g d c d d,
    g g'16-\soloE a h8 a g f
    e c16 d e8 d c h
    a f'16 g a8 g f e
    d f e d e e, %125
    a4 r r
    R2.*6 %132
    r8 \mvTr c16\fE-\tutti d e8 d c h
    c c16 d e8 d c h
    c c'16 h c8 g e c %135
    g4 r8 g'4 e8
    c4. c'4 a8
    f4. d8 h4
    c g2
    c4 r8 f-\solo g g, %140
    c4. d8\pE c h
    a4 r gis'
    a8 e'16 d c8 h a g
    f e d c16 h a8 h
    ...
    \time 4/4 \tempoB-IVEtUnam \newSpacingSection
      c8 \mvTr c'4\pE-\solo b8 a g16 f e8 c \noBreak %165
    a b c e f d a f
    b g c \hA b a16 a' g f e8 c
    f e d g e c cis4
    d8 e fis4 g4. f8
    e d c d e d e e, %170
    a a' gis e c a gis e
    a4 c8 a g4 h
    c2 \tempoB-IVMortuorum r
    R1*3 \noBreak %176
    R1\fermata \bar "||"
    \tempoB-IVEtVitam << {
      g'4 c2 a8 f \noBreak %178
    ...
    c4 a' fis g
    e4. d16 c d8 e c d
    << { g^\org g, a h } \\ { g_\vlne g a h } >> c2 %185
    \clef "treble_8" e8 a4 d8 c4. a8
    f4 d' h c
    a4. g16 f g8 a f g
    \clef bass c,2 g'4 e8 c
    d4 g, r8 g' c4~ %190
...
B-IVCredoBassFigures = \figuremode {
  r2 <6>4
  r2 \bo <[6]>4
  r2 \bc q4
  r4 <\t>2
  ...
  r4. <[6]>8 <7> <6> <\t> <7 5 [_+]>
  <6 4> <5 _+>4. <9>8 <8> <6[!]> <5>
  <9 4> <8 3>4 <3>8 <7 _+>4. <3 5>8 %75
  <9 4> <8 3>4 <3>8 <7 _+>4. <3[+] 5>8
  <9[+] 4> <8 _+> <6[!]> <\t> <9 4> <8 3> <7>4
  q4. q8 q2
  <7 _+>4. <_+> <[6]>4
  <[5 _+]>4 <6 4> \bo <[5 \t]> \bc <[\t _+]> %80
  r2 r8 <4\+ _!>4.
  <[6]>2 r8 <4\+ _->4.
  <6>2 r8 <7 5 [_+]>4.
  <_+>2 r8 \bo <[_!]> <6> \bc <[\t]>
  ...
  <6 4>2. <5 _+>4 %90
  r4. <[6]>8 <7> <6\\> <6!>4
  <7 _+>8 <6\\ 4> <6! \t>4 <7>8 <6-> <\t> <5>
  <4\+ 2>4 <6> <6 4> <5 _+>
  r <6>2.
  <6\\ 5->2 <8 6[-] 4>8 <_ 5 3>4. %95
  <3 5>2 <5 3>4 <6 4\+>
  <_+>2 <4\+ _->
  <6> <7[!] 5 [_+]>
  <_+>1
  r8 <_!> <_+>4 <7>8 <6\\> <5!>4 %100
  <9 4>8 <8 3>4. <7 [_-]>8 <6->4 <[6]>8
  <7> <6\\>4 <6->8 <7[-]> <6>4 <5>8
  <9 4> <8 3>4. <7[!] 5 [_+]>2
  <6 4>8 <5 _+>4. <5 4>4 <\t _+>
  r1 %105
  ...
  q <3> <2> <6> r2
  <7>4 <6[!]> <7> <6>
  <7>8 <6>4 <6 3>4 <6>8 <7> <6>
  <7> <6->4 <6>8 <3>4 <6 4> %195
  <5 \t> <\t 3>2.
  r1
  r2 <8 7>8 <_ 6>16 <_ 5> <8 3>4
  r2 <5 2>4 <6>
  <7> <_-> <5 2> <6> %200
  <7> <6> <2->8 <\t> <_-> <6>
  <7>8 <6>4 <5->8 <3> <4!> <6>4
...
B-IVSanctusOrgano = {
  \relative c {
    ...
    g4 e8 a g4 e8 c \noBreak %10
    g2 c\fermata \bar "||"
    \tempoB-IVPleni \mvTr a'8\fE-\solo e c a gis4 r8 e' \noBreak
    a g!16 f e8 a f d g h,
    c c' f, a f d h' g
    e c f fis g gis a d, %15
    g c, f h, e d c d
    e4 e, a r
    a'\pE r gis r8 e
    a4. e8 d2
    c4 r8 c h e a, d %20
    g, g' fis d h c d d,
    g4\fE r8 d' << { g4^\org } \\ { g,4_\vlne } >> r8 f'\pE
    e4 r8 c f4 r
    fis r8 \hA fis g4. f8
    e4 a d, g %25
    c, g'8 h c h a e
    ...
    g4 f e d c2 f~
    f4 e d2 c1
    \clef "treble_8" e'4 d c h a1
    g2 c2. h4 a2
    g1 \clef bass g, %40
    c h2 e
    d1 c
    \clef "treble_8" << { a''2 g4 f g1 } \\ { f,2 f'1 e4 d } >>
    e2 \clef bass g,1 fis4 e
    fis2 e4 d e1 %45
    d\breve
    g,1 r2 e'~
    e4 c e fis g f e d
...
B-IVSanctusBassFigures = \figuremode {
  <5 3>2 <6 4>8 <5 \t> <8 3> <\t 6>
  <7- 6> <\t 5> <6 \t> <\t 4> <5 4> \bassFigureExtendersOn <5 3>16 <5 2> <5 3>4 \bassFigureExtendersOff
  <5 3>2 <6 4>8 <5 \t> <8 3> <\t 6>
  <7! 6> <\t 5> <6 \t> <\t 4> <5 4> \bassFigureExtendersOn <5 3>16 <5 2> <5 3>4 \bassFigureExtendersOff
  r8 <6\\ 5->4. <8 6- 4>8 <\t 5 3>4. %5
  r8 <6\\ 5[!] 3>4. <8 6 4>8 <\t 5[!] 3>4.
  r2 <6 5>
  <7 _+>4 <6 4> <5! \t> <\t _!>
  <9 [_!]> <8 _-> <7- 5> 2
  r4 <7>8 <3[!]>4. <[6]>4 %10
  ...
  r <\t>4. <6 5>2
  r4. <_+>8 <6>4 q
  q4. \bo <[6]>4 \bc q <7 _!>8 %15
  <7>4 q <_+> <6>8 q
  <4>4 <_+>2.
  r2 <[6]>
  r4. <6 _!>8 <7>4 <6>
  r2 <[6]>8 <7> q <7 _+> %20
  r4 \bo <[6]> \bc q <6 4>8 <5 _+>
  r4. <_+>2 <4 2>8
  <6>1
  <6 5>2.. <4 2>8
  <7>4 q q q %25
  ...
  <8>\breve
  r2 <5>4 <6> <4>2 <3>
  <3 6>1 <3 #(dotbf 5)>2. <6>4
  r1. <5>4 <6\\>
  <5 4>2 <\t 3>1. %40
  <6 #(dotbf 3)>2. <_ 4\+>4 <6>2 q
  <#(dotbf 5) [_!]>2. <6>4 <5>2 <6>
  r1. <6>2
  <6 3>1. <[6]>2
  r1 <7>2 <6> %45
  <7 _+> <6 4> <5 \t> <\t _+>
...
B-IVBenedictusOrgano = {
  \relative c {
    \clef bass
    \key f \major \time 4/4 \tempoB-IVBenedictus
    ...
    c e f d h d e d
    c a' gis e a4. g8
    f2 e\fermata \markOsannaUtSupra \bar "||" %13 finis
  }
}

B-IVBenedictusBassFigures = \figuremode {
  r8 <3> <2> <6> <5> <6-> <5>4
  <5 2>8 <[\t \t]> <7> <6!> <6> q <5>4
  <4\+ 2>8 <6> <7 _+> <3[!]> <[6!] 4\+ 2> <6> <7> <6\\>
  <_+> <6> <7> <6[!]> <7 _+> <_-> <4> <_!>
  <[6!] 4\+ 2> <6> <7> <6\\>4 <3>8 <2!> <6 [_!]> %5
  <4\+ 2> <6> <7> <6\\>4. <_->8 <\t>
  <7> <\t> <7>4 q8 <\t> <7>4
  q8 <\t> <7>4 q8 <\t> <7> <\t>
  r2 <6!>8 <8 6> <3 6> <_ 5>
...
B-IVAgnusOrgano = {
  \relative c {
    ...
    h!4 c h ais \noBreak
    h2 e,\fermata \bar "||"
    \tempoB-IVDona \mvTr c'4.\fE-\tuttiE-! c8-! a'4-! cis,-! \noBreak
    d8-! e-! f-! e16 f g4 h,
    ...
    e'8 c16 d e8 d16 e f8 g a g %25
    f e d c h a << { g'[ f] } \\ { g,4 } >>
    e'8 d c h a h c4~
    c8 h16 a h4 c \clef "treble_8" << {
      gis'' %28
      a8 h c h16 a d4 fis,
    ...
    a g f e16 d e4. a8
    d,4. g8 e c f4~
    f8 e16 d e4 f \clef "treble_8" a8 g
    f e << { d'[ c] } \\ { d,4 } >> h'!8 a g f
    e d << { c'[ b] } \\ { c,4 } >> a'4. g16 f %40
    \clef bass c4. c8 a'4. g8
    fis e d c h! a << { g'[ f] } \\ { g,4 } >>
    e'8 d c b a g << { f'[ es] } \\ { f,4 } >>
    d'1
    g,4 \clef "treble_8" h'8 a g fis << { e'[ d] } \\ { e,4 } >> %45
    cis'8 h a g fis e << { d'[ c] } \\ { d,4 } >>
    h'8 a g f \clef bass c4. c8
    a'4 cis, d8 e f e16 f
    g4 h, c8 d e d16 e
    f4. d8 g4. e8 %50
    a4 f8 d g4 e8 c
    ...
    g2 c4 r
    r8 c' g e c4 c'
    g2 c,4 r\fermata \bar "|." %55 finis
  }
}

B-IVAgnusBassFigures = \figuremode {
  r2 <6 4>
  <5 4>4 <\t 3> <7 4 2>2
  <8 3> <[6]>
  <9>8 <8>4. <[6 _+]>2
