...
B-XXXVIIIKyrieOrgano = {
  \relative c {
    ...
    d4 r r\fermata \bar "||"
    \time 4/4 \tempoB-XXXVIIIKyrieB \mvTr d4\fE-\tutti e fis g \noBreak
...
B-XXXVIIIGloriaOrgano = {
  \relative c {
    ...
    r2 g4\pE h8 g %35
    c4 a e8 e' c a
    fis! g! d4 \tempoB-XXXVIIIQuiSedes g, r
    ...
    e2 h~-\tasto \noBreak
    h1\fermata \bar "||" %80
    \clef "treble_8" \tempoB-XXXVIIIAmen \newSpacingSection
...
B-XXXVIIICredoOrgano = {
  \relative c {
    ...
    d h g a d d d d \noBreak
    d4 r r2\fermata \bar "||"
    \key d \minor \tempoB-XXXVIIIEtIncarnatus
    ...
    g4 r r2\fermata \bar "||"
    \key d \major \tempoB-XXXVIIIEtUnam \mvTr d'2\pE-\solo cis \noBreak
    d cis4 ais
    h8 fis' h a! g2 %65
    fis4 fis cis a
    d c h8 h' fis d
    ...
    \clef treble \tempoB-XXXVIIIEtVitam \mvTr d''8\fE-\tutti d4 g8 fis d r h' \noBreak
...
B-XXXVIIISanctusOrgano = {
  \relative c {
    ...
    g! e cis d
    a r r2
    \tempoB-XXXVIIIPleni r8 a' cis a d d, r a'
    fis d r4 r2
    R1 %10
...
B-XXXVIIIBenedictusOrgano = {
  \relative c {
    ...
    fis8 g a4 a, \noBreak
    d r r\fermata \bar "||"
    \clef "treble_8" \key d \major \time 4/4 \tempoB-XXXVIIIOsanna
      \mvTr d2\fE-\tuttiE g \noBreak %25
    << {
      fis8 d' h g a d, d'4(
...
B-XXXVIIIAgnusOrgano = {
  \relative c {
    ...
    \mvTr a1\pE-\tasto \noBreak %15
    a4 r r2\fermata \bar "||"
    \tempoB-XXXVIIIDona d2\fE fis4 h~ \noBreak
    h d, cis a'~
    a c, h g'~
