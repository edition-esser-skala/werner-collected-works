...
B-XXXVIIIKyrieTromboneII = {
  \relative c' {
    \clef tenor
    \key d \major \time 4/4 \tempoB-XXXVIIIKyrie
    a8.\fE a16 a8 a a fis'16 e d8 cis
    fis e4 d8 cis4 r
...
B-XXXVIIIGloriaTromboneII = {
  \relative c' {
    ...
    r8 a\fE a a a a h h
    h h h h c e e dis
    e e\p dis e h h gis gis %20
    a a r fis g fis g4
    d8 d'\f a d d4 e8 d
    c4 c8 d d d r4
    d8. d16 d4^\critnote e e8 c \noBreak
    a h a4 h r\fermata \bar "||" %25
    \key e \minor \time 4/4 \tempoB-XXXVIIIQuiTollis R1*11 %36
    \after 2 \tempoB-XXXVIIIQuiSedes R1
    r4 r8 r16 g\fE d'8 d r4
    r r8 r16 d d8 h4 e8
    dis dis r e cis d d cis %40
    d4 r r8 h d h
    ...
    fis'8.\trill e32 d cis16 h cis dis e8.\trill d32 cis h16 a h cis
    d8.\trill cis32 h cis4 h a8 h~ %90
...
B-XXXVIIICredoTromboneII = {
  \relative c' {
    \clef tenor
    \key d \major \time 4/4 \tempoB-XXXVIIICredo
    a4\fE cis8 cis d e a, d
    cis4 r8 cis d4. cis8
    d4 d8 e d h a4
    a r r8 cis h a
    ...
    e4 r8 e d4 r8 a
    h g16 h d4 d r
    e\pE r8 e, h'4 r8 h %45
    e e, a c d d, r d
    g fis g4 d8 a'4\f d8
    h4 d c h8. h16
    a4 a8 d h g! g4
    g r8 e e4. e8 %50
    e4 a a r8 g!
    ...
    r2 a8\fE a4 d8 %75
    cis a r e' d cis16 a h8.\trillE h16
    a4 r r2
    a8 a4 d8 h g r d'
    d^\critnote a d8. d16 cis4 r16 g h cis
    d8 d, a' a e' e, h'4 %80
    fis'8 fis, h cis d d, r4
...
B-XXXVIIIAgnusTromboneII = {
  \relative c' {
    \clef tenor
    \key d \major \time 4/4 \tempoB-XXXVIIIAgnus
    d8\fE a a fis fis ais4 cis8
    h4 h8 fis' e e h4
    cis r r2
    a!4. a8 h4 h
    h8 e4 cis8 a a a4 %5
