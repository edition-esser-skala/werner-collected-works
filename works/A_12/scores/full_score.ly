...
\book {
  ...
  %           \new Staff {
  %             \set Staff.instrumentName = "1"
  %             \A-XIIScenaTertiaViolinoI
  %           }
  %           \new Staff {
  %             \set Staff.instrumentName = "2"
  %             \A-XIIScenaTertiaViolinoII
  %           }
  %         >>
  %         \new Staff {
  %           \set Staff.instrumentName = \markup \concat { "vla " \critnote }
  %           \A-XIIScenaTertiaViola
  %         }
  %       >>
  %       \new ChoirStaff \with { \setGroupDistance #12 #13 } <<
  %         \new Staff {
  %           \set Staff.instrumentName = "soli"
  %           \new Voice = "Soli" { \dynamicUp \A-XIIScenaTertiaSoli }
  %         }
  %         \new Lyrics \lyricsto Soli \A-XIIScenaTertiaSoliLyrics
  %       >>
  %       \new StaffGroup <<
  %         \new Staff {
  %           \set Staff.instrumentName = "bc"
