...
P-IVSymphoniaPrimaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key c \major \time 2/4 \tempoP-VISymphoniaPrima
    c8\fE e e d
    c e e d
    c e h g
    c e e d\p
    ...
    c e16 f g8 g, \noBreak %70
    c4 r\fermata \bar "||"
    \time 4/4 \tempoP-VISymphoniaPrimaB \newSpacingSection
    ...
    a,4 a'8 g! f2 \noBreak
    e r\fermata \bar "||"
    \time 3/8 \tempoP-VISymphoniaPrimaC \newSpacingSection
    \repeat volta 2 {
      c8\fE d e \noBreak
      f4 r8 %80
      g4 f8
...
P-IVSymphoniaPrimaBassFigures = \figuremode {
  r4. <6>8
  r4. q8
  r4 <[6]>
  r4. <6>8
...
P-IVSonataPrimaBassoContinuo = {
  \relative c {
    \clef bass
    \key a \minor \time 3/4 \tempoP-VISonataPrima
    a'4\fE a, h
    c a h
    c cis a
    d2.
...
P-IVSonataPrimaBassFigures = \figuremode {
  r2 <6\\>4
  <6>2 <6\\>4
  <6> \bo <[\t]> \bc <[_+]>
  r2 <6>8 <5>
...
P-IVSymphoniaSecundaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key b \major \time 2/4 \tempoP-VISymphoniaSecunda
    b8\fE b'4 a8
    g f16 es d4
    es f
    b16 f d b d8 f
    ...
    \time 3/4 \tempoP-VISymphoniaSecundaB \newSpacingSection
      g'4\fE f es \noBreak
    d2 c4
    b h2
    c r4
    ...
    \time 3/8 \tempoP-VISymphoniaSecundaC \newSpacingSection
    \repeat volta 2 {
      b'8\fE d, b \noBreak
      f'4 r8
      r g a %65
...
P-IVSymphoniaSecundaBassFigures = \figuremode {
  r4. \bo <[6]>8
  r4 \bc q
  r2
  r
...
P-IVSonataSecundaBassoContinuo = {
  \relative c {
    \clef bass
    \key g \dorian \time 3/2 \tempoP-VISonataSecunda
    ...
    es,1. \noBreak
    d\fermata \bar "||"
    \twotwotime \time 2/2 \tempoP-VISonataSecundaB \newSpacingSection
      R1*17 %34
    g1\fE %35
    d'
    es2 d4 cis
    ...
    d1 \noBreak
    g,\fermata \bar "||"
    \time 3/4 \tempoP-VISonataSecundaC g4\fE g' r8 g \noBreak
    fis2 r4
    d d' r8 d %115
    cis4 d r
    b g8 a b4
    ...
    d4 cis2 \noBreak
    d2.\fermata \bar "||" %125
    \time 3/8 \tempoP-VISonataSecundaD \newSpacingSection
      r8 g\fE f! \noBreak
    es d e
    f a g
    f e fis
...
P-IVSonataSecundaBassFigures = \figuremode {
  r2 \bo <[6]>1
  \bc <[_-]>2 <6>1
  <6> <7 5 [_!]>2
  <_+>1.
...
P-IVSymphoniaTertiaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key f \major \time 2/4 \tempoP-VISymphoniaTertia
    f8\fE g a b
    a4 b
    << { c s } \\ { c,8 d e f } >>
    e4 c
    ...
    f4 c \noBreak
    f, r\fermata \bar "||"
    \time 3/4 \tempoP-VISymphoniaTertiaB \newSpacingSection
      d'4\fE d d \noBreak
    d d d %100
    d d d
    d d d
    ...
    h h h \noBreak
    a2.\fermata \bar "||" %110
    \time 3/8 \tempoP-VISymphoniaTertiaC \newSpacingSection
    \repeat volta 2 {
      f'8\fE f f \noBreak
      f f f
      f f f
...
P-IVSymphoniaTertiaBassFigures = \figuremode {
  r4 \bo <[6]>8 <2>
  \bc <[6]>2
  r
  r
...
P-IVSonataTertiaBassoContinuo = {
  \relative c {
    \clef bass
    \key f \dorian \time 3/4 \tempoP-VISonataTertia
...
P-IVSonataTertiaBassFigures = \figuremode {
  r4 <6> <4!>
  <6> q <_->8 <_!>
  <6>4 <6- 4> <5 _!>
  <[6]> <5!> <6!>
...
P-IVSymphoniaQuartaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key a \major \time 2/4 \tempoP-VISymphoniaQuarta
    a4\fE cis8 a
    e'4. fis8
    gis4 e
    a4. h8
    ...
    d\f e \noBreak
    a, r\fermata \bar "||" %80
    \time 3/4 \tempoP-VISymphoniaQuartaB \newSpacingSection
      fis'2\fE e4 \noBreak
    d d' c
    h2.
    e,4 cis2
    ...
    r r his\pE \noBreak
    cis2 r4\fermata \bar "||"
    \time 3/8 \tempoP-VISymphoniaQuartaC \newSpacingSection
    \repeat volta 2 {
      a8\fE a'4~ \noBreak
      a8 gis e
      fis4 gis8 %95
...
P-IVSymphoniaQuartaBassFigures = \figuremode {
  r2
  r
  <[6]>
  r
...
P-IVSonataQuartaBassoContinuo = {
  \relative c {
    \clef bass
    \key e \minor \time 3/4 \tempoP-VISonataQuarta
    e8\fE fis g4 e
    fis h gis
    a e fis
    g! d e
...
P-IVSonataQuartaBassFigures = \figuremode {
  r2.
  <7>4 <_+> <6>
  r <6 [_!]>2
  r4 <6> <\t>
...
P-IVSymphoniaQuintaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key d \major \time 2/4 \tempoP-VISymphoniaQuinta
    d8\fE d d d
    d d d d
    a a a a
    d d d d
    ...
    d g\f a a, \noBreak
    d4 r\fermata \bar "||"
    \time 3/4 \tempoP-VISymphoniaQuintaB \newSpacingSection
      h'2\fE h4 \noBreak
    ais2 r4 %85
    ais2 ais4
    h, h' a
    ...
    eis \noBreak
    fis\fermata \bar "||"
    \time 3/8 \tempoP-VISymphoniaQuintaC \newSpacingSection
    \repeat volta 2 {
      d8\fE fis d \noBreak
      a'4 r8 %100
      a, cis a
...
P-IVSymphoniaQuintaBassFigures = \figuremode {
  r2
  <6 4>8 <5 3>4.
  <7>2
  r
...
P-IVSonataQuintaBassoContinuo = {
  \relative c {
    \clef bass
    \key d \dorian \time 3/4 \tempoP-VISonataQuinta
    d2\fE e4
    f fis g
    a b2
    a4 g! e
...
P-IVSonataQuintaBassFigures = \figuremode {
  r2 <6\\>4
  <6> \bo <[\t]> \bc <[_-]>
  <_+> <7> <6\\>
  <_+> <6 _!> <6\\>
...
P-IVSymphoniaSextaBassoContinuo = {
  \relative c {
    \clef bass
    \twofourtime \key g \major \time 2/4 \tempoP-VISymphoniaSexta
    g'8\fE g, g' a
    h c h a
    g h16\pE a g8 a
    h c h a
    ...
    g' c, d d, \noBreak
    g4 r\fermata \bar "||" %45
    \time 4/4 \tempoP-VISymphoniaSextaB \newSpacingSection
    ...
    dis dis e e c c c c \noBreak
    h2 r\fermata \bar "||"
    \time 3/8 \tempoP-VISymphoniaSextaC \newSpacingSection
    \repeat volta 2 {
      g'8\fE g g \noBreak
      g,4 r8
      g' d' d, %55
...
P-IVSymphoniaSextaBassFigures = \figuremode {
  r4. \bo <[6]>8
  \bc q4. <6>8
  r4. \bo <[6]>8
  \bc q4. <6>8
...
P-IVSonataSextaBassoContinuo = {
  \relative c {
    \clef bass
    \key c \dorian \time 3/4 \tempoP-VISonataSexta
      \once \override Staff.TimeSignature.style = #'single-digit
    c4\fE es r8 r16 g
    c,4 c r
    r r r8 r16 es
...
P-IVSonataSextaBassFigures = \figuremode {
  r4 <6> r8. <_!>16
  r2.
  r
  r
