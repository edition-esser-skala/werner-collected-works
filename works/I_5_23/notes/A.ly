...
I-V-XXIII-Alto = {
  \relative c' {
    ...
    r8 e g e d8. d16 d4
    r2 a'8 a, a' g
    f4 f8 e dis[ e16 \hA dis] e4~ %10
    e dis r8 g g a
    h4 a8 gis a16([ \hA gis)] a8 r4
    r2 g8. g16 d8 g
    g16([ fis)] fis8 r4 e8. e16 h8 e
    e16([ dis)] dis8 r4 r8 gis gis gis %15
    a16([ gis)] a([ h)] \appoggiatura a8 \hA gis4\trill a r
    r2 e8 e e16([ d)] d([ c)]
    c([ h)] h8 r4 r2
    f'8 f fis e16 \hA fis g4 a8 g16([ \hA fis)]
    g8. fis16 e4 e8 r e r %20
    e r f r a r a a
    a4.( gis8) a4 d,8 f
    e2\trill e4 r\fermata \bar "|." %23 finis
  }
}
