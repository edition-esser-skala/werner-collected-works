...
D-III-VIIaOrgano = {
  \relative c {
    \clef bass
    \key f \major \time 4/2 \tempoD-III-VIIaa
    ...
    c\breve \noBreak
    f,\fermata \bar "||" %40
    \clef "treble_8" \time 3/2 \tempoD-III-VIIac
...
D-III-VIIaBassFigures = \figuremode {
  r1 <6>
  <4>2 <3> <6 5>1
  r2 <[_-]> <7 _+>1
  <4>2 <_+>1.
...
D-III-VIIbOrgano = {
  \relative c {
    \clef bass
    \key d \minor \time 4/2 \tempoD-III-VIIba
      \set Staff.timeSignatureFraction = 2/2
    d2 d1 cis2
    d d, b'1
    a r2 f'
    ...
    a\breve~ \noBreak
    a1 d\fermata \bar "||"
    \key a \minor \clef "treble_8" \time 3/2 \tempoD-III-VIIbc
      \unset Staff.timeSignatureFraction
      a'2^\aTre c! a \noBreak %25
    e'1.~
    e1 dis2
...
D-III-VIIbBassFigures = \figuremode {
  r2 <3> <4 2> <[6]>
  r1 <7>2 <6>
  <_+>1. <[5!]>2
  r\breve
...
D-III-VIIcOrgano = {
  \relative c {
    \clef bass
    \key a \minor \time 4/2 \tempoD-III-VIIca
      \set Staff.timeSignatureFraction = 2/2
    a'1 e
    d a
    f\breve
    ...
    e d1 \noBreak
    a1.\fermata \bar "||"
    \clef "treble_8" \time 4/2 \tempoD-III-VIIcc
      \set Staff.timeSignatureFraction = 2/2
      c2^\aTre c'2. c4 g2 \noBreak
    a f4 e d2 c %50
    g' a g1~
...
D-III-VIIcBassFigures = \figuremode {
  r1 <5 4>2 <6\\ 3>
  <5 4> <\t 3> <4> <3[!]>
  <7>1 <6\\>
  <8 _+>\breve
