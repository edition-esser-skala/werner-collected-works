...
B-LVIIIKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- %5
  lei -- _ _ _ _
  _ son, e -- lei --
  son.
...
B-LVIIIGloriaSoprano = {
  \relative c' {
    ...
    d r r
    R2.*7 %29
    \time 4/4 \tempoB-LVIIIDomine r8 \mvTr d\fE^\tutti d c d d d c \noBreak %30
    d d r4 r d8 d
    ...
    b4( a) b r \noBreak %40
    R1\fermata \bar "||"
    \tempoB-LVIIIQuiTollis \mvTr g4\pE^\solo d'2 c8 es \noBreak
    b4. as8 as([ g)] g4
    R1*3 %46
    f8 b4( g8) ges4. ges8
    ges([ f)] f f b4. a!8
    ...
    b, b b4. a!8 g4
    \tempoB-LVIIIQuiSedes a r r8 \mvTr c\fE^\tutti d([ c)]
    d4 r r8 f, g([ f)]
    g4 r8 c c b16 b a8([ b)]
    a f([ g)] a b([ c)] d([ es)] \noBreak %55
    f([ d] c4) d r\fermata \bar "||"
    \tempoB-LVIIIQuoniam \mvTr g,8\pE^\soloE \tuplet 3/2 8 { b16([ a g)] } d'8 \tuplet 3/2 8 { fis16([ e d)] } g8 g, r g \noBreak
    ...
    R1\fermata \bar "||"
    \tempoB-LVIIICumSancto \mvTr b4\fE^\tuttiE d4.( c16[ b)] a8([ g)] \noBreak
...
B-LVIIIGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra, ter -- ra
  pax,
  pax, pax ho -- mi -- ni --
  bus bo --
...
B-LVIIICredoSopranoLyrics = \lyricmode {
...
B-LVIIISanctusSoprano = {
  \relative c' {
    ...
    g8 a fis4. fis8 \noBreak %10
    g4 r r
    \tempoB-LVIIIPleni r8 b c c a a16 a \noBreak
...
B-LVIIISanctusSopranoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san -- ctus,
  san -- ctus Do -- mi --
...
B-LVIIIBenedictusSoprano = {
  \relative c' {
    \clef treble
    \key g \minor \time 3/4 \autoBeamOff \tempoB-LVIIIBenedictus
    R2.*11 \noBreak %11
    R2.\fermata \bar "||"
    \key b \major \time 4/4 \tempoB-LVIIIOsanna R1*4 %16
    r2 \mvTr f'\fE^\tutti
    d4 b8 d c f, f' f
...
B-LVIIIBenedictusSopranoLyrics = \lyricmode {
  O -- %17
...
B-LVIIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus
