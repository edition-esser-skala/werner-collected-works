...
B-LVIIIGloriaViolinoI = {
  \relative c' {
    ...
    R2.*4
    \time 4/4 \tempoB-LVIIIDomine r8 d'\fE f a b16 f d f d8 f %30
    ...
    \tempoB-LVIIICumSancto b'4\fE d4. c16 b a8 g \noBreak
...
B-LVIIISanctusViolinoI = {
  \relative c' {
    ...
    \tempoB-LVIIIPleni b8 d g es c f~ \noBreak
    f d r b\pE a fis
    b4 r8 b a fis
    b4. g16 c b8 a %15
    b16 a b8 r4 r
...
B-LVIIIAgnusViolinoI = {
  \relative c' {
    ...
    \tempoB-LVIIIDona r8 d'16\fE c b a g f es8 es'16 d c b a g \noBreak
