...
B-LVIIIKyrieBassoLyrics = \lyricmode {
  Chri -- ste e -- %7
  lei -- son, e -- lei -- son, e --
  lei -- son, e -- lei --
  son, e -- lei -- son, e -- %10
...
B-LVIIIGloriaBasso = {
  \relative c {
    ...
    \time 4/4 \tempoB-LVIIIDomine b8 \mvTr b\fE^\tutti b f d b b' f \noBreak %30
    d b r4 r b8 g'
...
B-LVIIIGloriaBassoLyrics = \lyricmode {
...
B-LVIIICredoBassoLyrics = \lyricmode {
  Et in u -- num Do -- mi -- %5
...
B-LVIIISanctusBasso = {
  \relative c {
    ...
    c d4. d8 \noBreak %10
    g,4 r r
    \tempoB-LVIIIPleni r8 g' es c f! f16 f \noBreak
    d8 b r4 r
    R2.*3 %16
    r8 b d b es c
...
B-LVIIISanctusBassoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san -- ctus,
  san -- ctus Do -- mi --
...
B-LVIIIBenedictusBassoLyrics = \lyricmode {
  O -- san -- na, o -- %13
  san -- na in ex -- cel -- _
  _ _ _ _ %15
  sis, in __ ex -- cel --
...
B-LVIIIAgnusBassoLyrics = \lyricmode {
  Mi -- se -- %4
  re -- re no -- %5
  _ bis.
