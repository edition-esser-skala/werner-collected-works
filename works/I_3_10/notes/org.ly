...
I-III-X-Organo = {
  \relative c {
    ...
    d cis h h' e, d cis a
    << { h'[ gis] } \\ { h,4-\critnote } >> a'8 fis gis e fis d
    e cis16 d e8 e, a a'4\fE gis8~ %10
    gis fis4 e d cis16 h
    << { a'8[ gis] } \\ { a,4-\critnote } >> fis'8 e16 d cis8 d e e, \noBreak
...
I-III-X-BassFigures = \figuremode {
  r4. <[6]>2 <6>8
  <7> <6>4 q2 <[6]>8
  r4 <6>4. q
  r4 q8 q4 <\t>8 <5> <\t>
