...
I-III-X-Soprano = {
  \relative c' {
    ...
    gis8 a16 fis \appoggiatura a8 gis8.\trill a16 a4 r %10
    R1*2 \noBreak
    R1\fermata \bar "||"
    ...
    d16([ cis h8)] \appoggiatura a4 gis2\trill
    a4 r r
    R2.*5 %24
    h8([ e)] dis cis h a %25
    ...
    cis[ d cis a] h[ cis h g] a[ h a fis] g[ a \hA g e]
    ...
    dis[\trill cis \hA dis e] e[\trill dis e fis]
    fis[ e dis cis] h4
    R2*3 %116
    r8 e h cis
