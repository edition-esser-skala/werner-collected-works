...
I-III-X-ViolinoI = {
  \relative c' {
    ...
    a e8 fis16 \appoggiatura cis8 h8.\trillE a16 a4 r\fermata \bar "||"
    \time 3/4 \tempoI-III-X-b \newSpacingSection
      R2.*5 %18
    \mvTr cis8(\fE-\solo e) a( cis) h16( cis) d8
    a gis h d, e,16( gis) h( d) %20
    d8(\trill cis) a'2
    a16( fis) dis( h) \appoggiatura h8 a4\trill gis8( fis)
    ...
    \parOn d-\parenthesize-! \parOff r h-\parenthesize-! r cis a e cis
    d-!\p r h-! r a a'\f e cis
    r2 r8 fis4\p a8
    ...
    fis'8\p fis, fis4\trillE r2 %60
    r4 fis'16( e) fis8 r2
    r4 \once \slurDashed fis,16( e) fis8 r2
    r16 a h cis d e fis8 r2
    a,8 fis' g, e' fis, d' e, cis'
    d,4 r r2 %65
    r fis8\f a d fis
    cis, e g e' fis,16 d fis a d8 r
    cis,\p e g e' fis,16 d fis a d8 fis\f
    \parOn g-\parenthesize-! r \parOff e-\parenthesize-! r fis d a fis \noBreak
    \parOn g-\parenthesize-! r \parOff e-\parenthesize-! r fis4 r\fermata \bar "||" %70
    ...
    r4 a''16( gis) a8
    R2
    r8 e-! r dis-\parenthesize-! %110
    r e-! r fis-\parenthesize-!
    r fis r e\f
