...
B-LXXICredoAltoLyrics = \lyricmode {
  Pa -- trem o --
  mni -- po --
  ten -- tem, fa --
  cto -- rem
...
B-LXXIQuiPropterAltoLyrics = \lyricmode {
  Et in -- car -- %89
...
B-LXXICrucifixusAltoLyrics = \lyricmode {
  Cru -- ci -- %104
  fi -- xus %105
...
B-LXXIEtResurrexitAltoLyrics = \lyricmode {
  Et re -- sur -- %210
  re -- xit
...
B-LXXIEtInSpiritumAltoLyrics = \lyricmode {
...
B-LXXIEtVitamAltoLyrics = \lyricmode {
  Et %271
  vi -- tam ven --
  tu -- ri sae -- cu --
  li, a -- _ _
