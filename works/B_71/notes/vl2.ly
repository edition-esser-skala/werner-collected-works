...
B-LXXIKyrieViolinoII = {
  \relative c' {
    ...
    \key d \minor \time 3/2 \tempoB-LXXIChriste \newSpacingSection
      R1. \noBreak
    r4 d\fE f a,4. gis8 a h
    c!4 a r es'2 d8 c %20
    b!4 g r d'2 c8 b
    a4 a' g f f e
    f2 e4 d2 cis4
    d8 a d\p c b a g4 f e
    d2 r r %25
    r4 a'2 a4 fis8 a g \hA fis
    g4 g, r2 r
    r4 c' b a g8 a b g
    a4 f b,2 c
    f4 f8 g a4 a h c %30
    ...
    g4 e r b'2 a8 g
    f4 d8 e f g a2 g4
    \tempoB-LXXIChristeB a2 r4 a\p f g
    a1.\fermata \markKyrieUtSupra \bar "||"
  }
}
...
B-LXXIGloriaViolinoII = {
  \relative c' {
    ...
    \time 3/2 \tempoB-LXXILaudamus a4 c f e8 d c4 b \noBreak %5
    a4 f r c' d2
    g, r4 a' g f
    c'2 c,4 a g f
    c' a e f d e
...
B-LXXICrucifixusViolinoII = {
  \relative c' {
    ...
    r4 a'\pE^\markup \remarkE "staccato" a a a a
    r g g g g g
    r fis fis fis fis fis %105
    r g g g d d
    r e e e g g
    r c, c c c c
    r d d d d d
    ...
    r a a a a a
    r d, d' d d d
    r cis cis cis cis cis %115
    r a a a a a
    r e e e d! d
    c a a a a a \noBreak
    a gis gis2 r\fermata \bar "||"
...
B-LXXIEtResurrexitViolinoII = {
  \relative c' {
    ...
    e8 c' d, c' g, h'
    c16 d e f g a h g c8 c,\fermata \bar "||" %249 finis
  }
}
...
B-LXXIEtInSpiritumViolinoII = {
  \relative c' {
    ...
    R1*3 %252
    r4 a'8\pE a f'4 a,8 f'
    e8. d16 c4 r2
    R1 %255
    r4 r16 g h d e8 g, r16 g' e c
    d8 g, r16 g h g e'8 c, r16 c' e c
    g'8 g, r16 g d' g, e' g, f' g, g'8 b,
    a4 r r16 d, g d a'8 a,
    r16 e' cis a d8 a r4 r16 d f d %260
    e8 a, r4 r2
    r16 f' b f c' f, a f d'8 f, r4
    R1
    r2 r4 r8 a
    gis16( a) a(^\critnote h) h8 h' r2 %265
