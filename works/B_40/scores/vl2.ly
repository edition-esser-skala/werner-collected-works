...
\book {
  ...
  \bookpart {
    ...
    \score {
      <<
        \new Staff { \B-XLQuiTollisViolinoII }
      >>
    }
  }
  \bookpart {
  ...
  \bookpart {
    ...
    \score {
      <<
        \new Staff { \B-XLCumSanctoViolinoII }
      >>
    }
  }
  \bookpart {
  ...
  \bookpart {
    ...
    \score {
      <<
        \new Staff { \B-XLCrucifixusViolinoII }
      >>
    }
  }
  \bookpart {
    ...
    \score {
      <<
        \new Staff { \B-XLEtResurrexitViolinoII }
      >>
    }
  }
  \bookpart {
