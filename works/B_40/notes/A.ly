...
B-XLKyrieAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLVIKyrie
    R1*4
...
B-XLGloriaAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLVIGloria
    ...
    c2\trill \tempoB-XLVIQuiSedes h4 r8 \mvTr gis'\fE^\tuttiE
    ...
    gis r8 gis( a) gis a4
    \time 3/4 \tempoB-XLVIAmen gis4 r8 e[ a^\critnote fis]~ \noBreak
    fis d r h[ h' gis]~
    gis e a16([ e] a4 gis8)
    a4 a4.( fis8) %70
    dis h'([ gis)] a fis4
...
B-XLCredoAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 3/2 \autoBeamOff \tempoB-XLVICredo
...
B-XLSanctusAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 3/4 \autoBeamOff \tempoB-XLVISanctus
    R2.*2
    ...
    R2.*13 \noBreak %28
    R2.\fermata \bar "||"
    \time 3/4 \tempoB-XLVIOsanna r4 r \mvTr e\fE^\tuttiE \noBreak %30
...
B-XLBenedictusAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLVIBenedictus
...
B-XLAgnusAlto = {
  \relative c' {
    \clef treble
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLVIAgnus
    R1*10 %10
    ...
    gis8 h([ a)] gis4 r8 \noBreak
    r h([\pE a)] gis4 r8
    \key a \minor \time 4/4 \tempoB-XLVIDonaB a8 a a a b4 b \noBreak
    a8 a a a a4. a8
    gis gis a2( gis4) %45
