...
B-XLGloriaOrgano = {
  \relative c {
    ...
    dis4 h e r
    gis e a f! \noBreak
    dis8 dis dis dis \tempoB-XLVIQuiSedes e4 r8 \mvTr e\fE-\tuttiE
    ...
    \time 3/4 \tempoB-XLVIAmen e' \clef treble << {
      h'' e cis4 a8 \noBreak
      r fis fis' d4 h8
      e8. d16 cis8
    } \\ {
...
B-XLSanctusOrgano = {
  \relative c {
    ...
    a4 r8 a a a \noBreak
    a4 r r\fermata \bar "||"
    \clef "treble_8" \time 3/4 \tempoB-XLVIOsanna << {
      r4 r e'' \noBreak %30
...
B-XLAgnusOrgano = {
  \relative c {
    ...
    \key a \minor \time 4/4 \tempoB-XLVIDonaB r2 g8 g g g \noBreak \noBreak
