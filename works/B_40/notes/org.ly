...
B-XLGratiasBassFigures = \figuremode {
  r2. %23
  <_->2 <_+>4
  r2 <6 _!>4 %25
  r2.
...
B-XLDomineBassFigures = \figuremode {
  r4. <_+>8 r4 <[6]> %58
  <_+>2 \bo <[6 5]>8 <6>4.
...
B-XLQuiTollisBassFigures = \figuremode {
  r2 <6! 5-> %79
...
B-XLQuoniamBassFigures = \figuremode {
  r2. %98
  <[6]>
  r %100
  r2 <[6]>4
...
B-XLCumSanctoBassFigures = \figuremode {
  r1 %131
  r8 <8 3> <6>2.
  r4. \bo <[6]>8 <7> <\t> <5>4
  <7>8 <\t> <6> \bc <[6\\]> r2
...
B-XLEtIncarnatusOrganoSolo = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \tempoB-XLEtIncarnatus
...
B-XLEtIncarnatusBassFigures = \figuremode {
  r1 %48
  r
  r %50
  r
...
B-XLCrucifixusBassFigures = \figuremode {
...
B-XLEtResurrexitOrgano = {
  \relative c {
    ...
    c c' e, c f,4. g8 \noBreak
    a2 g\fermata \bar "||"
    \tempoB-XLEtVitam \mvTr c'8\fE-\tutti c,16 d e8 f e f e d \noBreak
...
B-XLEtResurrexitBassFigures = \figuremode {
  r1 %87
  r
  r
  r %90
