...
B-XLQuiTollisTenoreLyrics = \lyricmode {
  Qui tol -- %79
  lis pec -- ca -- ta %80
  mun -- di:
...
B-XLQuoniamTenore = {
  \relative c' {
    \clef "treble_8"
    \key c \major \time 3/4 \autoBeamOff \tempoB-XLQuoniam
...
B-XLQuoniamTenoreLyrics = \lyricmode {
...
B-XLCumSanctoTenoreLyrics = \lyricmode {
  Cum San -- cto %131
  Spi -- ri -- tu in glo -- ri --
  a, in glo -- ri -- a
  De -- i Pa -- tris,
...
B-XLEtResurrexitTenoreLyrics = \lyricmode {
  Et re -- sur -- %88
