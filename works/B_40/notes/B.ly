...
B-XLDomineBasso = {
  \relative c {
    \clef bass
    \key a \minor \time 4/4 \autoBeamOff \tempoB-XLDomine
...
B-XLDomineBassoLyrics = \lyricmode {
...
B-XLQuiTollisBassoLyrics = \lyricmode {
  Qui tol -- %79
  lis pec -- ca -- ta %80
  mun -- di:
...
B-XLCumSanctoBassoLyrics = \lyricmode {
...
B-XLCrucifixusBassoI = {
  \relative c {
    \clef bass
    \key c \dorian \time 4/4 \autoBeamOff \tempoB-XLCrucifixus
...
B-XLCrucifixusBassoILyrics = \lyricmode {
  Cru -- ci -- fi -- xus %74
  e -- %75
  ti -- am pro no -- bis,
  pro no -- bis pas -- sus,
...
B-XLCrucifixusBassoIILyrics = \lyricmode {
  Cru -- ci -- %73
  fi -- xus e --
  ti -- am pro no -- bis, %75
  pro no -- bis
...
B-XLEtResurrexitBassoLyrics = \lyricmode {
  Et re -- sur -- %88
...
B-XLBenedictusBassoI = {
  \relative c {
    \clef bass
    \key a \minor \time 4/4 \tempoB-XLBenedictus \autoBeamOff
...
B-XLBenedictusBassoILyrics = \lyricmode {
...
B-XLBenedictusBassoIILyrics = \lyricmode {
  Be -- ne -- di -- ctus, qui
  ve -- nit,
