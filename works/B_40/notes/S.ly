...
B-XLGloriaSoprano = {
  \relative c' {
    ...
    e8 h gis e c'4 a \noBreak
    a2\trill \tempoB-XLVIQuiSedes gis8 \mvTr h\fE^\tuttiE e4~
    ...
    h4 r8 h( cis) h a([ cis)]
    \time 3/4 \tempoB-XLVIAmen h8 h([ e] cis4) a8 \noBreak
    r fis([ fis'] d4) h8
...
B-XLSanctusSoprano = {
  \relative c' {
    ...
    R2.*13 \noBreak %28
    R2.\fermata \bar "||"
    \time 3/4 \tempoB-XLVIOsanna R2.*3 %32
...
B-XLAgnusSoprano = {
  \relative c' {
    ...
    e4 cis16([ a)] h8 e, r \noBreak
    e'4\p cis16([ a)] h8 e, r
    \key a \minor \time 4/4 \tempoB-XLVIDonaB c' c c c cis4 cis \noBreak
    d8 d d d c4. c8
    h( e4) c8 h2 %45
