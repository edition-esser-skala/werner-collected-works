...
J-IISoprano = {
  \relative c' {
    ...
    as2. g8 as
    b4 b,8([ c)] d4 c8([ h)]
    c4. c8 h2\fermata \bar "||" %40
    \key c \major \time 6/4 \tempoJ-IIc \newSpacingSection
      R1.*6 %46
    r2 r4 g'2 a4
    h h c d e fis
    g g, c2 h4 a
    gis4.( a8 \once \stemUp h2) a4 g %50
    fis4.( g8 a2) g4 f
    e2 f4 g2 a4
    h( c) d g, c8[ d] e4~
    e d8[ e] f2 e4 d
