...
LIIIClarinoI = {
  \relative c' {
    ...
    \time 4/4 \tempoLIIIc c,4\fE r8 e16 f g8 g g g \noBreak
    g4 r8 e16 f g8 g g g
    g4 r8 g a4 r8 a
    ...
    g4 r r2 %60
    R1*3
    \time 3/4 \tempoLIIIe R2.*12 %75
    r8 \pa g''4\fE c8 h h \pd
    r \pa g4 e8 d d \pd
    r \pa e~ e16 f g8 a g \pd
    g g r4 r
    R2.*5 %84
    r4 r8 \mvTr g~\pE-\solo \sbOn g16 f \tempoLIIIf \tuplet 3/2 8 { e d c } \sbOff %85
    ...
    R2.*7 %98
    \time 4/4 \tempoLIIIg r8 \mvTr e4\fE-\tutti g8 g g g g \noBreak
    g g r4 r2 %100
    R1*2
    r2 \pa g4\fE r8 e
    a fis g4 \pd r2
