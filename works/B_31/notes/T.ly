...
B-XXXIKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son, e --
  lei -- son,
  e -- lei -- son, e --
  lei -- son, e --
...
B-XXXIGloriaTenore = {
  \relative c' {
    ...
    h( ais8[ h16 cis)] h4 r \noBreak
    R1\fermata \bar "||" %80
    \tempoB-XXXIAmen r8 d!4 d8 cis16[ e a,8] r c \noBreak
...
B-XXXIGloriaTenoreLyrics = \lyricmode {
  Et in ter -- ra
  pax ho -- mi -- ni --
  bus bo -- nae
  vo -- lun -- ta --
...
B-XXXICredoTenore = {
  \relative c' {
    ...
    h4 a h r \noBreak
    R1\fermata \bar "||"
    \key d \major \tempoB-XXXIEtUnam R1*8 \noBreak %70
    R1\fermata \bar "||"
...
B-XXXICredoTenoreLyrics = \lyricmode {
...
B-XXXISanctusTenore = {
  \relative c' {
    ...
    d4 e8 h a4. a8
    a4 r r2
    \tempoB-XXXIPleni r8 a a a a a r a
    a a r4 r2
    R1 %10
...
B-XXXISanctusTenoreLyrics = \lyricmode {
  San --
  ctus,
  san --
  ctus,
...
B-XXXIBenedictusTenoreLyrics = \lyricmode {
  O -- san -- %25
...
B-XXXIAgnusTenoreLyrics = \lyricmode {
  A -- gnus De -- i, qui
