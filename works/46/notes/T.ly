...
XLVITenore = {
  \relative c' {
    \clef "treble_8"
    \key c \major \time 3/2 \autoBeamOff \tempoXLVIVeni
    ...
    R1.*3 \noBreak %16
    R1.\fermata \bar "||"
    \key a \minor \time 4/4 \tempoXLVICum
    ...
    \key f \major \time 3/4 \tempoXLVIBeata R2.*10 %36
    ...
    b([ d)] \tuplet 3/2 4 { c([ d es)] } d([ c)]
    d4.( e8) e([ f)]
    f4. e16([ d)] c8([ b)]
    a([ b)] b([ c)] \tuplet 3/2 4 { c([ d es)] }
    ...
    \key a \minor \time 4/4 \tempoXLVIExurge
    ...
    a4 g d'2 \noBreak %90
    d r\fermata \bar "||"
    \key c \major \time 4/4 \tempoXLVIAlleluia
    ...
    d16[ h h16.(\trill a64 h)] c16_[ a a16.(\trill g64 a)] \sbOff h32([ g16.) d'32( h16.)] e8.[\trill d16]
    ...
    h[ d e f] \sbOn g^[ g, g16.(_\trill f!64 g)] \sbOff a16[ c d e] \sbOn f[ f, f16.(_\trill e64 f)] \sbOff %105
    g16[ h c d] \sbOn e[ e, e16.(_\trill d64 e)] \sbOff f16[ a d c] h[ a g f]
    e[ g8 c g b16]~ b[ a8 d a c16]~
    c[ h8 e h d16]~ d[ c] h([ a]) g([ f]) e([ d)]
    \sbOn \tuplet 3/2 8 { e[_\trill d e g_\trill f g] c[\trill h c e\trill d e] a,[_\trill g a c_\trill h c] d[\trill c d f\trill e f] } \sbOff
