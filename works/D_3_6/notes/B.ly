...
D-III-VIaBasso = {
  \relative c {
    ...
    c\breve \noBreak
    f\fermata \bar "||" %40
    \time 3/2 \tempoD-III-VIac R1.*14 \noBreak %54
      \unset Staff.timeSignatureFraction
    R1.\fermata \markUtVivificaretUtSupra \bar "||" %55 finis
  }
}

D-III-VIaBassoLyrics = \lyricmode {
  Si -- cut
  o -- vis ad
  oc -- ci -- si -- o -- nem
  du -- ctus est,
...
D-III-VIbBasso = {
  \relative c {
    ...
    b!1 a~
    a a \noBreak
    a2. a4 d1\fermata \bar "||"
    \key a \minor \time 3/2 \tempoD-III-VIbc
      \unset Staff.timeSignatureFraction
      R1.*16 \noBreak %40
    R1.\fermata \markQuiaInTeUtSupra \bar "||" %41 finis
  }
}

D-III-VIbBassoLyrics = \lyricmode {
  Ie -- ru -- sa --
  lem sur --
  ge et
  ex -- u -- e te
...
D-III-VIcBasso = {
  \relative c {
    ...
    \time 4/2 \tempoD-III-VIcc
      \set Staff.timeSignatureFraction = 2/2
      R\breve*11 \noBreak %59
    R\breve\fermata \markQuiaVenitDiesUtSupra \bar "||" %60 finis
  }
}

D-III-VIcBassoLyrics = \lyricmode {
  Plan -- ge,
  plan -- ge,
  plan --
  ge qua --
