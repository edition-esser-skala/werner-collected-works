...
H-I-XVLaudateOrgano = {
  \relative c {
    ...
    h g r c, h g r c' %5
    h g r c, h g' e f
    g f g g, c \clef "treble_8" c'[-\aTre c c]
    gis gis gis a e e e e
    a a f d a' a a a
    << { d d h c! } \\ { d,4 } >> g8 \clef bass e[-\tutti h c] %10
    g g' e c' a f g g,
    c4 \mvTr c'8\pE-\solo b a4 e8 c
    f, f' e d cis4 a
    d8 c b f' g e a g
    fis4 g8 f e4 h %15
    c8 c' h a gis4. e8
    ...
    h fis h a gis4 e
    a a, e' f %25
    g!8. g16 f8 e d e f g
    a g16 f e8 f g f g g,
    c, c'4 d8 e e' d c
    h a gis e a e a g
    f e d f e e' c a %30
    \mvTr gis\fE-\tutti e16 fis \hA gis8 e a e c a
    e' e' gis, e a gis a a,
    e e'16 fis gis8 e a e c a
    e' e' c a f d e e,
    a \clef "treble_8" << {
      e''4 f e16 d e fis g!8~ %35
      g f16 e f g a4 g8 fis4
      s8
    } \\ {
      r8 r a,4 c h16 a %35
      h cis d4 c16 h c d e4 dis8
      e
    } >> \clef bass e,4 g fis16 e \hA fis gis a8~
    a g f4 e \clef "treble_8" << {
      e'8 d
      c16 e d c h4 s8
    } \\ {
      gis16 a \once \tieDashed h8~
      h a4 gis8 a
    } >> \clef bass a,4 c8~
    c h16 a h cis d4 c8 h4 %40
    a8 a'16 g! f4 e2~
    e1~
    e8 a16 g! f e d8 e4 e,
...
H-I-XVLaudateBassFigures = \figuremode {
  ...
  <[6]>2 <_+>
  q4 <[6]> <4> <_+>
  r <6 5>4. <6>8 \bo <[6]>4 %10
  r4 \bc q2 <3>4
  r2 <6>4 <[6]>
  r8 <6> <6\\>4 <[6]>2
  r <_->4 <_+>
  \bo <[6]>8 <5!> \bc <[_!]>4 <6> q8 <5> %15
  r4 <6\\>8 <6> q2
  r1
  <6->2 <[6!] 4\+ 2>
  <6>4. q8 <6 4>4 <5 _+>
...
H-I-XVLaetatusOrgano = {
  \relative c {
    ...
    f2. d4 f d %5
    a'2 f4 d a2
    d4. e8 \mvTr f4\pE-\solo e8 d cis4 h
    a a'8 g f4 e d c
    b!8 b' a g f4 g a g
    f8 g f e d4 f e c %10
    f e d c8 b a4 d
    b b' c g c b
    a g8 f e4 c d e
    f es d a b b'
    ...
    c c' h a gis \hA h %25
    a f c2 d4 f
    e fis gis \hA fis8 e \hA fis4 \hA gis
    a g8 f e4 d c h
    a f' e d e e,
    a \mvTr a'\fE-\tutti g! f e d %30
    c e8 d c4 h c g'
    c g e h c c,
    g'2 r4 g' a h
    c2 h a4 a,
    e'4. e8 f4 c g' g, %35
    c c'8 b! \mvTr a4\pE-\solo e f,8 f' e d
    cis4 a d f e c
    f e d c b b'
    a e f b, c c'
    f, e d e f d %40
    ...
    c2 f,4 \clef "treble_8" << {
      ...
      c h c
    } >> \clef bass c,8 d e f g4
    r d8 e f g a4 g8 f e4 %55
    d e << {
      r f8 g a b c4
      r g8 a b c d4
    } \\ {
      f,2 r4 c8 d
      e f g4 r d8 e f g a4
    } >>
    r d8 c! b a g4 r c8 b
    a g f4 r b8 a g f e d
    c4 f c' f, c2 %60
    f,1^\critnote r2\fermata \bar "|." %61 finis
  }
}
...
H-I-XVNisiOrgano = {
  \relative c {
    ...
    a f d e f4 e8 a
    d, e f e d4 e8 e,
    a4 r8 \mvTr d\fE-\tutti cis a r d
    cis a r f' g f e4
    d r f4. c'!8 %10
    a g fis d g f e d
    cis4 d8 c h4 c
    cis8 cis cis cis d4 \clef "treble_8" r8^\aTre \mvTr fis\pE-\soloE
    g4 a b4. a8
    b \clef bass b,[ d b] f'4 g %15
    f es8 d c4 b8 a
    g b'4 g8 a d, a4
    d d' cis a
    f8 d16 e f8 d e4 c!
    ...
    e d8 \clef treble << {
      ...
      f,8 e4 fis8 g~ %32
      g16 a f g e8
    } >> \clef "treble_8" a, d, \clef bass d[ a a']~
    a g4 f16 e f4. d8
    a' a, d e f8. g16 a4 %35
    d, e f g
    a8 d, a4 d r\fermata \bar "|." %37 finis
  }
}
...
H-I-XVNisiBassFigures = \figuremode {
  ...
  r4. <_+>4 <8>8 <4> <3[!]>
  <2-> <6> <4\+ 2>4 <6>2
  <4>8 <3[!]> <6 5> <5 3> <9 5> <8 6> <4> <_+> %35
  <9> <8> <9 7> <8 6\\> <9 5\+> <8 6> <9> <8>
...
H-I-XVMagnificatOrgano = {
  \relative c {
    ...
    g'8 f g g, c c' h a
    g f e d << { c' h a g } \\ { c,4 s } >> %5
    fis8 e d c h c d d,
    g \mvTr h'\pE-\solo a g fis e d c
    h g c e d h fis fis'
    g fis e \hA fis g a h g
    c h a c h a g fis %10
    e d! c h16 a gis8 e' a f
    d f e e, a4 a'8 g!
    fis4^\critnote d8 \hA fis g g, h g
    c c' e, c g g' f e
    d f g g, c h a d %15
    g, g' a h c, c' h a
    gis e a g f e d c!
    h g! a h e, e' g e
    dis h' h, dis e e' c a
    fis d'! h g e c a a' %20
    fis d h c d c d d,
    g h' fis d e e' h g
    c, c' h gis a e c a
    e' d c h a c d f!
    e d e e, a \mvTr a'\fE-\tutti f g! %25
    c, c' a h e, e c d!
    g, g' e a d, \clef "treble_8" d'[ c! h]
    a \clef bass a[ g f] e d cis h
    a d a4 d8 \mvTr f\pE-\solo cis a
    d e f d e c'! d, e %30
    f4 e8 a d, e f4
    g8 e d g c,4 d8 e
    f4 f, b h8 g
    c b a g << { f' e d c } \\ { f,4 s } >>
    h!8 c g' g, c4 d %35
    e8 fis gis e a f d e
    ...
    \tempoH-I-XVMagnificatB g,8 << {
      ...
      \mvTr g,4\fE-\tuttiE e8 a8._\trillE g32 a f!16 d f8 %40
      g8.\trill f32 g e8 c a''8.\trill g32 a f16 d f8
      g8.\trill f32 g e8 a16 g fis8 g4
    } >> \clef "treble_8" d8
    h \clef bass g4 e8 a8.\trill g32 a f!16 d f8
    g8.\trill f32 g e8 c' a f d d'
    g,8. e16 c8 e f d g e %45
    a f h g c h a e
    f c g' g, c4 r\fermata \bar "|." %47 finis
  }
}
...
H-I-XVMagnificatBassFigures = \figuremode {
  ...
  \bo <[6 _+]>2. <6>4
  q q q2 %20
  \bc <[6 5]>4 <7>8 <5> <6 4>4 <5 _+>
  r4 <[6]>2.
  r8 <6> <6\\> <[6]> r2
  <_+>4 <6>8 <6\\> r2
  <6 4>4 <5 _+>2 <6 5>4 %25
  r <6\\>8 <[5\+] _+>4. <6 5>8 <_+>
  r4. <_+>8 <[_!]> <10> q q
  q \bo <[10]> <10> \bc <[6]>4. <5>8 <[6]>
  <7 _+>4 <4>8 <_+>4. <[6]>4
  r2 <6[!]>4 <6-> %30
  <5>8 <6> <7>2 <6>8 <5>
  r8 <[6]> <7> q4. <6->4
  <9>8 <8>4. <9>8 <8> <6>4
  r4 \bo <[6 _]>8 \bc <[6 _-]> r2
