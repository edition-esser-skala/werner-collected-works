...
B-XLIVKyrieSopranoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei --
  son, e -- lei --
  son, e -- lei --
  son,
...
B-XLIVGloriaSopranoLyrics = \lyricmode {
...
B-XLIVCredoSoprano = {
  \relative c' {
    ...
    R2.*13 \noBreak %53
    R2.\fermata \bar "||"
    \key d \major \time 3/4 \tempoB-XLIVEtResurrexit
...
B-XLIVCredoSopranoLyrics = \lyricmode {
  Fa -- cto -- rem %2
  coe -- li __ et
  ter -- rae,
  et in u -- num %5
...
B-XLIVSanctusSopranoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san --
  ctus,
...
B-XLIVBenedictusSopranoLyrics = \lyricmode {
  O -- %19
  san -- na %20
  in ex -- cel --
  sis,
...
B-XLIVAgnusSoprano = {
  \relative c' {
    ...
    cis r\fermata \bar "||"
    \time 3/4 \tempoB-XLIVDona \mvTr a4(\pE^\solo d) cis \noBreak %15
    d8([ e] fis4) e
    a,( d) cis
    d8([ e] fis4) e
    d( cis) h
...
B-XLIVAgnusSopranoLyrics = \lyricmode {
  A -- gnus De -- i, qui
