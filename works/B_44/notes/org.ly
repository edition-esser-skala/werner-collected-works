...
B-XLIVKyrieBassFigures = \figuremode {
  r2 <[6]>4. <3>8
  r2 \bo <[6]>4. \bc <[3]>8
  r2. <6>4
  r1
...
B-XLIVGloriaBassFigures = \figuremode {
  r2 r8 <6> <7> <_+>
...
B-XLIVCredoOrgano = {
  \relative c {
    ...
    d4 d' cis d a h \noBreak
    fis4. g8 a4 d a2 %70
    \clef bass \time 4/4 \tempoB-XLIVEtInSpiritum \newSpacingSection
...
B-XLIVCredoBassFigures = \figuremode {
  r2 <[6]>1
  <6>2 q4 q <5> <6>
  <5> <6\\> <5 3>2 <6>4 q
  <6 4> <5 _+> r2 <[6]>
...
B-XLIVSanctusBassFigures = \figuremode {
  r2.
  <5>4 <6>2
  r4 \bo <[6] 4> \bc <[5] 3>
  r2.
...
B-XLIVBenedictusBassFigures = \figuremode {
  r2 <[6]>1
  r2 <_+> <\t>
  <6>1.
  <5>4 <6> <4>2 <_+>
...
B-XLIVAgnusOrgano = {
  \relative c {
    ...
    a fis h2 \noBreak
    a r\fermata \bar "||"
    \time 3/4 \tempoB-XLIVDona \mvTr d,2\pE-\solo e4 \noBreak %15
    fis d cis
    r fis e
    r d^\critnote cis
    << { h' } \\ { h, } >> a' g
...
B-XLIVAgnusBassFigures = \figuremode {
  r2 <6 _!>
  <6> <6>4 <5>
  <_+> <6>8 <6!> <6> <5> <9> <8>
