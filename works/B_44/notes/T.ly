...
B-XLIVKyrieTenoreLyrics = \lyricmode {
  Ky -- ri -- e e -- lei --
  son, e -- lei --
  son, e -- lei --
  son,
...
B-XLIVGloriaTenoreLyrics = \lyricmode {
  Lau -- da -- mus %1
  te,
...
B-XLIVCredoTenoreLyrics = \lyricmode {
...
B-XLIVSanctusTenoreLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san --
  ctus,
...
B-XLIVBenedictusTenoreLyrics = \lyricmode {
  Be -- ne --
  di -- ctus, qui
  ve -- nit,
  qui ve -- nit, qui
...
B-XLIVAgnusTenore = {
  \relative c' {
    ...
    e2 r\fermata \bar "||"
    \time 3/4 \tempoB-XLIVDona R2.*13 %27
...
B-XLIVAgnusTenoreLyrics = \lyricmode {
  Mi -- se -- %7
  re -- re no -- bis,
  no -- bis.
  A -- gnus De -- i, __ %10
