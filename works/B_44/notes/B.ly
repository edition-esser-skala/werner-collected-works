...
B-XLIVKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei --
  son, e -- lei --
  son, e -- lei --
  son, e -- lei --
...
B-XLIVGloriaBassoLyrics = \lyricmode {
  Bo -- nae vo -- lun -- ta --
  tis, ad -- o -- ra -- mus
  te, glo -- ri -- fi -- ca -- mus
  te.
...
B-XLIVCredoBassoLyrics = \lyricmode {
  Vi -- si -- bi -- li -- um %4
...
B-XLIVSanctusBassoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san --
  ctus,
...
B-XLIVBenedictusBassoLyrics = \lyricmode {
  O -- san -- _ _ %16
  na in ex --
  cel --
  sis, in ex --
...
B-XLIVAgnusBasso = {
  \relative c {
    ...
    a fis h2 \noBreak
    a r\fermata \bar "||"
    \time 3/4 \tempoB-XLIVDona R2.*16 %30
    r4 \mvTr a\fE^\tutti g!
    fis2 e4
    r d cis
    r fis e
...
B-XLIVAgnusBassoLyrics = \lyricmode {
  A -- gnus De -- i, qui %10
  tol -- lis pec -- ca -- ta
  mun -- di, pec --
  ca -- ta mun --
