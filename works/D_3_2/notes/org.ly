...
D-III-II-aOrgano = {
  \relative c {
    \clef "treble_8"
    \twotwotime \key d \minor \time 4/2 \tempoD-III-II-aa
    ...
    r8 f f f b4 fis \noBreak
    g2 d\fermata \bar "||"
    \clef "treble_8" \tempoD-III-II-ad \time 3/2 \newSpacingSection
      f'!1^\aTre f2 \noBreak
    b,4 c d e f2
    b, g4 a b c %50
    d2 d h
...
D-III-II-aBassFigures = \figuremode {
  r\breve
  <12>2 <5>1 <[6]>2
  <3> <10> <4> <3>
  <6 [5]> <\t 4> <5 \t> <\t 3>
...
D-III-II-bOrgano = {
  \relative c {
    \clef bass
    \key e \minor \time 4/2 \tempoD-III-II-ba
      \set Staff.timeSignatureFraction = 2/2
      \markTimeSig #'(4 2)
    e\breve
    e2 e e1
    ...
    a\breve \noBreak %25
    e'\fermata \bar "||"
    \clef treble \time 4/4 \tempoD-III-II-bb \newSpacingSection
      \unset Staff.timeSignatureFraction
    << {
      r2 c''4 d~ \noBreak
      d h c8 d c h
    ...
    e h~ \noBreak
    h e,\fermata \bar "||"
    \clef "treble_8" \time 3/2 \tempoD-III-II-bc \newSpacingSection
      g'4^\aTre a h2 g \noBreak
    d' h e
    a, fis g! %50
    d1 r2
...
D-III-II-bBassFigures = \figuremode {
  <_+>\breve
  r1 <5 _+>2 <6\\ \t>
  \bo <8 5 [_!]> \bc <\t 6 [\t]>1.
  r1 <5 4>2 <\t _!>
...
D-III-II-cOrgano = {
  \relative c {
    \clef bass
    \key b \major \time 4/2 \tempoD-III-II-ca
      \set Staff.timeSignatureFraction = 2/2
      \markTimeSig #'(4 2)
    b1 b'
    f2 fis g1
    ...
    f1 f, \noBreak
    b\breve \bar "||"
    \clef "treble_8" \time 3/2 \tempoD-III-II-cc \newSpacingSection
      g'2^\aTre b g \noBreak
    d' d, r
    c c' c %45
    c4 h g2 b
...
D-III-II-cBassFigures = \figuremode {
  r\breve
  <4>2 <3> <9> <8>
  <5->1 <6\\>
  \bo <[5] _+>1 <6 \t>2 \bc <[7!] _!>
