...
B-XLIIKyrieOrgano = {
  \relative c {
    ...
    \clef treble \key c \major \tempoB-XLIIKyrieII
...
B-XLIILaudamusBassFigures = \figuremode {
  r4 <_+>2. %18
  <7>4 <_+> r8 <[7]> <7> q
...
B-XLIIGratiasBassFigures = \figuremode {
  r2 <[6]>4 %36
  r2 <6>4
  <_-> <6>2
  r4 \bo <[6]> <6>
...
B-XLIIDomineBassFigures = \figuremode {
  r2. <[6]>4 %70
  r2 <4>4 <6>
  <_-> <6> r8 <6> <6!>4
  <_+>4 \bo <[6]>8 <6\\> r2
...
B-XLIIQuiTollisOrgano = {
  \relative c {
    ...
    f a b4. g8
    e4 f c r
    \clef bass r2 \tempoB-XLIIQuiSedes \mvTr c4\fE-\tuttiE r8 c
...
B-XLIIQuiTollisBassFigures = \figuremode {
  r1 %114
  r %115
  r8 <_+>4. <7! 5 [_+]>2
  <6 4>4 <5 _+>2.
...
B-XLIIQuoniamBassFigures = \figuremode {
  r1 %139
  \bo <[6]>4. <6>8 r2 %140
  r4 q2 \bc <[6]>4
  r2. <6 4>8 <5 3>
...
B-XLIICumSanctoOrgano = {
  \relative c {
    ...
    \tempoB-XLIICumSanctoFuga c16\trill-!-\tasto h-! c8-! e16\trill-! d-! e8-! r8 f4-! a8-! \noBreak
...
B-XLIICumSanctoBassFigures = \figuremode {
  <_+> 2 r8 <7> <6\\>4 %162
  <_+>2 r8 q4.
  <6>1
  q2. <[6]>4 %165
...
B-XLIIEtIncarnatusOrganoSolo = {
  \relative c' {
    \clef treble
    \key f \lydian \time 3/4 \tempoB-XLIIEtIncarnatus
...
B-XLIIEtIncarnatusBassFigures = \figuremode {
  r2.*8 %51
  r2 <[6]>4
  r2.
  r
...
B-XLIICrucifixusBassFigures = \figuremode {
  r2 <6 4 3>8 <\t \t 3> <\t \t \t>4 %72
  r1
  <4\+ _->2 <6>
  <_-> <4! _-> %75
...
B-XLIIEtResurrexitBassFigures = \figuremode {
  r1. %86
  \bo <[6]>
  \bc q1 <6>4 <[6 5]>
  r2 <6 5> <_+>
