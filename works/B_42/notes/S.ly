...
B-XLIILaudamusSoprano = {
  \relative c' {
    \clef treble
    \key a \minor \time 4/4 \autoBeamOff \tempoB-XLIILaudamus
...
B-XLIILaudamusSopranoLyrics = \lyricmode {
  Lau -- da -- _ mus te, %23
  lau -- da -- _ _
  _ _ mus te, be -- ne -- %25
...
B-XLIIDomineSopranoLyrics = \lyricmode {
  Do -- mi -- ne, %101
  Do -- mi -- ne De -- us, A --
  gnus De -- i, Fi --
  li -- us Pa --
...
B-XLIIQuiTollisSoprano = {
  \relative c' {
    ...
    c4 f8 c d8. d16 d8 b
    c4( a) g r
    r2 \tempoB-XLIIQuiSedes r8 \mvTr g\fE^\tutti c4~
    c c r8 c f4~
    f f r8 d g4~ %130
    g g r8 e c f16 f
    e8 e r4 r2
...
B-XLIIQuiTollisSopranoLyrics = \lyricmode {
  Qui tol -- %114
...
B-XLIIQuoniamSoprano = {
  \relative c' {
    \clef treble
    \key c \major \time 4/4 \autoBeamOff \tempoB-XLIIQuoniam
...
B-XLIIQuoniamSopranoLyrics = \lyricmode {
...
B-XLIICumSanctoSopranoLyrics = \lyricmode {
...
B-XLIICrucifixusSopranoLyrics = \lyricmode {
  Cru -- ci -- fi -- xus, %72
  cru -- ci --
  fi -- xus e -- ti -- am,
  e -- ti -- am pro %75
...
B-XLIIEtResurrexitSopranoLyrics = \lyricmode {
  Et re -- sur -- re -- xit %86
  ter -- ti -- a di -- e
  se -- cun --
  dum Scri -- ptu --
...
B-XLIIBenedictusSoprano = {
  \relative c' {
    \clef treble
    \key a \minor \time 4/4 \autoBeamOff \tempoB-XLIIBenedictus
    R1*5 %5
...
B-XLIIBenedictusSopranoLyrics = \lyricmode {
  Be -- ne -- di -- ctus, qui %6
