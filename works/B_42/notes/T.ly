...
B-XLIIKyrieTenore = {
  \relative c' {
    ...
    \mvTr e8.\fE^\tutti e16 e8 e d d r4
    c8. c16 c8 c h h r h
    c2 c4 r8 c
    d2 d4 r8 g,
    g4 g8 d' c4 h8 d %5
    ...
    e r8 f d([ e] d4) \noBreak
    e r r2\fermata \bar "||"
    \key c \major \tempoB-XLIIChriste
      R1*20 \noBreak %53
    R1\fermata \bar "||"
    \key c \major \tempoB-XLIIKyrieII R1*9 %63
    ...
    a4 a h8([ a)] g c %80
    a4 h2 h4
    c8.[ d16] e8[ c] a[ d] a[ fis16 g]
    a8[ g16 fis] g8[ a] h4 r
    r g a2
    a4 a h4. c16[ d] %85
    e4. d16[ e] c8[ a] d4~
    d8[ h] d[ c16 d] h4 h
...
B-XLIIDomineTenoreLyrics = \lyricmode {
  Do -- %78
  mi -- ne De --
  us, Rex coe -- le -- %80
  stis, De --
  us Pa -- ter, De --
  us Pa -- ter o --
  mni -- po -- tens. %84 finis
}

B-XLIIQuiTollisTenore = {
  \relative c' {
    \clef "treble_8"
    \key c \major \time 4/4 \autoBeamOff \tempoB-XLIIQuiTollis
      \set Score.currentBarNumber = #114
    \mvTr g2\fE^\tutti f8([ e)] d([ g)]
    g4( a8.[ h!16)] c4 r %115
    r8 e e e fis2
    e r
    R1
    r8 g,!4 g8 a4 a
    r8 a4 a8 fis'4 e %120
    cis2 fis,
    ...
    f a b4. g8
    e4( f) c r
    r2 \tempoB-XLIIQuiSedes r4 r8 \mvTr g'\fE^\tutti
    a8([ c16 a] g8[ c16 g)] a4 r8 c
    d([ f16 d] c8[ f16 c]) d4 r8 d %130
    e([ g16 e] d8[ h16 d]) e8 c c c16 c
    c8 c r4 r2
    r r8 e4 e8
    a,4 a r8 fis'4 fis8
    h,4 h r8 c4 c8 %135
...
B-XLIIQuiTollisTenoreLyrics = \lyricmode {
  Qui tol -- lis, %114
  tol -- lis %115
  pec -- ca -- ta mun --
  di:
...
B-XLIICumSanctoTenore = {
  \relative c' {
    \clef "treble_8"
    \key c \major \time 4/4 \autoBeamOff \tempoB-XLIICumSancto
      \set Score.currentBarNumber = #162
    \mvTr gis2\fE^\tutti r8 c4 h16([ a)]
    h8. h16 h4 r8 e e e16 e
    d4 d r8 d d d16 d
    c4 g g8([ e')] d4 %165
    c2\trill h4 r
    r2 r4 r8 h(
    c) h c4 h r\fermata \bar "||"
    \tempoB-XLIICumSanctoFuga R1*3 %171
    ...
    r h'([ g)] e c'4.( h8) %195
    c c([ g)] d' c e d4
    e r r2\fermata \bar "|." %197 finis
  }
}

B-XLIICumSanctoTenoreLyrics = \lyricmode {
  Cum San -- cto %162
...
B-XLIIEtIncarnatusTenore = {
  \relative c' {
    \clef "treble_8"
    \key f \major \time 3/4 \autoBeamOff \tempoB-XLIIEtIncarnatus
...
B-XLIIEtIncarnatusTenoreLyrics = \lyricmode {
  Et __ in -- car -- %52
  na -- tus est,
  et in -- car --
  na -- _ _ %55
...
B-XLIICrucifixusTenoreLyrics = \lyricmode {
  Cru -- ci -- fi -- xus, %72
  cru -- ci --
  fi -- xus
  e -- ti -- am pro %75
...
B-XLIIEtResurrexitTenore = {
  \relative c' {
    ...
    f d f' e d c b a %125
    gis gis gis4\trill a r
    R1*2 \noBreak
    R1\fermata \bar "||"
    \tempoB-XLIIEtVitam R1*3 %132
    \mvTr c8\fE^\tutti c4 c8 a f4 a8
    g c, c'4. h16 a h[ g a h]
    c[ d e f] e[ d c d] h[ c d c] h[ g a h] %135
    c4 g r2
    R1
    r2 e'8 e4 e8
    c a4 c8 h e, e' d16 e
...
B-XLIIEtResurrexitTenoreLyrics = \lyricmode {
  Et, et re -- sur -- %86
  re -- xit ter -- ti -- a
  di -- e se -- cun -- dum __
  Scri -- ptu --
  ...
  Et in Spi -- ri -- tum San -- ctum, %113
  Do -- mi -- num et vi -- vi -- fi --
  can -- tem, qui ex Pa -- tre Fi -- li -- %115
  o -- que pro -- ce -- _
  dit. Qui __ cum Pa -- tre et __
  Fi -- li -- o si -- mul ad -- o -- ra --
  tur et con -- glo -- ri -- fi --
  ca -- tur: qui lo -- cu -- tus est per __ %120
  Pro -- phe -- tas.

  Con -- fi -- te -- or u -- num ba -- %124
  ptis -- ma in re -- mis -- si -- o -- nem %125
  pec -- ca -- to -- rum.

  Et vi -- tam, vi -- tam ven -- %133
  tu -- ri sae -- cu -- li, a --
  _ _ _ _ %135
  _ men,
...
B-XLIISanctusTenore = {
  \relative c' {
    ...
    \mvTr g2\fE^\tutti a4 c~
    c e a, b~
    b a d4.( h8)
    g8 r r4 r2
    r8 g4 g8 a8. a16 a4 %5
    r8 a4 a8 a4 a
    r8 a4 a8 g4 g
    g4. g8 g4 r \noBreak
    R1\fermata \bar "||"
    \tempoB-XLIIPleni R1*3 %12
    ...
    c8([ g)] e([ c)] r4 g'
    c8 g c4. h16([ a)] h4\trill
    c c8 d e4( c)
    d8 d8.([ c16)] h([ a)] g8[ e']~ e16[ d c h] %40
    a8 a8.([ g16)] f16([ e)] d8[ f']~ f16[ e d c]
    h8 g16([ a h c)] d8 c16[ d e8]~ e16[ f g8]
    c, c f4.( e8 f16[ e f8])
    d4 r8 h16([ d)] e8 d r h16([ d)]
    e8 d e8. e16 c8([ f)] d4\trill %45
    e8 c c([ h)] c4 r
...
B-XLIIAgnusTenore = {
  \relative c' {
    ...
    h4 r r2 \noBreak %20
    R1\fermata \bar "||"
    \tempoB-XLIIDona R1*2 %23
    \mvTr g4\fE^\tutti g' g8 fis16([ e)] d8 c
    h g c a d h c([ d)] %25
    g, g4 a8 g16([ a h c] d[ c d8])
    g,8 a4  h c16[ h] a8[ d]~
    d[ h16 a] h8 e c4( d)
    g, a h8 g16[ a] h[ g a h]
    c4~ c16[ d c d] e8 d16([ c)] h8 a %30
    g4 c4. h16[ a] g[ a h8]
    c8 h a16([ h] c4) d8 h4
    a8 c[ h gis] a[ c h d]
    c4 d e r
    ...
    h( c4 d) e8 f16([ e f d)]
    e8 c4( d16[ c)] h4 r
    g8. a16 h8 c d[( h16 c] d[ c h d]) %40
    g,2 r
    r4 r8 e' d[ g, g' f]
    e4. d16[ c] d2\trill
    e4 r8 c( f4 d)
...
B-XLIIAgnusTenoreLyrics = \lyricmode {
  ...
  Do -- na, do -- na no -- bis %24
  pa -- cem, do -- na no -- bis %25
  pa -- cem, do -- na no --
  bis pa -- _ _ _
  _ cem, pa --
  cem, no -- bis pa -- _
