...
B-XLIIKyrieAlto = {
  \relative c' {
    ...
    \key c \major \tempoB-XLIIChriste
      R1*20 \noBreak %53
    R1\fermata \bar "||"
    \key c \major \tempoB-XLIIKyrieII R1*4 %58
...
B-XLIIGratiasAlto = {
  \relative c' {
    \clef treble
    \key f \lydian \time 3/4 \autoBeamOff \tempoB-XLIIGratias
...
B-XLIIGratiasAltoLyrics = \lyricmode {
  Gra -- ti -- as __ %36
  a -- gi -- mus, __
  a -- gi -- mus
  ti -- bi,
...
B-XLIIDomineAltoLyrics = \lyricmode {
  Do -- mi -- ne, %84
  Do -- mi -- ne Fi -- li u -- %85
  ni -- ge -- _
  _ _ ni --
...
B-XLIIQuiTollisAlto = {
  \relative c' {
    ...
    g f e r
    r2 \tempoB-XLIIQuiSedes r4 r8 \mvTr e\fE^\tuttiE
...
B-XLIIQuiTollisAltoLyrics = \lyricmode {
  Qui tol -- %114
  _ _ _ _ lis %115
  pec -- ca -- ta mun --
  di:
...
B-XLIICumSanctoAlto = {
  \relative c' {
    ...
    \tempoB-XLIICumSanctoFuga R1*6 %174
...
B-XLIICumSanctoAltoLyrics = \lyricmode {
...
B-XLIICrucifixusAltoLyrics = \lyricmode {
  Cru -- ci -- fi -- xus,
  cru -- ci --
  fi -- xus e -- ti -- am,
...
B-XLIIEtResurrexitAltoLyrics = \lyricmode {
  Et, et re -- sur -- %86
  re -- xit ter -- ti -- a
  di -- e se -- cun --
  dum Scri -- ptu --
