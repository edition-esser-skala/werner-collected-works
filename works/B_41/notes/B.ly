...
B-XLIKyrieBasso = {
  \relative c {
    \clef bass
    \key a \major \time 3/4 \tempoB-XLIKyrie \autoBeamOff
...
B-XLIKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei --
  son, e -- lei --
  son, e -- lei --
  son,
...
B-XLIGloriaBasso = {
  \relative c {
    \clef bass
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLIGloria
...
B-XLIGloriaBassoLyrics = \lyricmode {
  Et in ter -- ra __
  pax ho -- mi -- ni --
  bus bo -- nae, bo --
  nae, bo -- nae, bo --
...
B-XLICredoBasso = {
  \relative c {
    \clef bass
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLICredo
...
B-XLICredoBassoLyrics = \lyricmode {
...
B-XLISanctusBasso = {
  \relative c {
    \clef bass
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLISanctus
    \mvTr a'2(\fE^\tutti fis4) d
    h8([ h')] g([ e)] fis2
    h,4 r r8 e fis g
    a4 fis8([ d)] e4 a8([ d,)]
    e4. e8 a,4 r %5
    r2 \tempoB-XLIPleni r8 a' a^\critnote cis
    a([ a,)] cis e a, a r4
    R1*7 %14
...
B-XLISanctusBassoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus, san --
  ctus Do -- mi -- nus
  De -- us, __ De -- us __
...
B-XLIBenedictusBasso = {
  \relative c {
    \clef bass
    \key fis \minor \time 3/8 \autoBeamOff \tempoB-XLIBenedictus
    \mvTr fis4.\pE^\solo
    gis
    a
    h4 gis8
    ...
    cis8 a fis
    gis cis h
    a16[\trill gis a cis fis, a]
    gis[\trill fis gis h eis, gis] %15
    fis[ gis a gis a h]
    cis8.[ gis16] a([ fis)]
    d([ h)] cis8.\trill cis16
    fis,4 r8
    ...
    \key a \major \time 4/4 \tempoB-XLIOsanna \newSpacingSection
      \mvTr a'4.(\fE^\tuttiE gis8) a4( fis) \noBreak %25
    e a8([ gis)] fis4. e8
    fis4 d cis( a8[ h]
    cis4 a) e'2
    r8 h'([ a)] gis fis8.[ e16] d8[ cis]
...
B-XLIBenedictusBassoLyrics = \lyricmode {
  Be --
  ne --
  di --
  ctus, qui
...
B-XLIAgnusBasso = {
  \relative c {
    \clef bass
    \key a \major \time 4/4 \autoBeamOff \tempoB-XLIAgnus
...
B-XLIAgnusBassoLyrics = \lyricmode {
  A -- gnus De --
  i, qui tol --
  lis pec -- ca -- ta
  mun -- di:
