...
H-I-VIIDixitOrgano = {
  \relative c {
    \clef bass
    \key g \major \time 4/4 \tempoH-I-VIIDixit
    \mvTr g8\pE-\solo g' fis d g16 f e d c8 c'~
    c h a g fis d g e
    cis d a4 d8 fis g g,
    d' dis e g h h, g' e
    c a h a gis e' a g %5
    fis d! g16 f e d c h a g fis8 \mvTr g\fE-\tutti
    d' d, g g' e h c h
    a4 e'8 e gis e a f
    d c g' g,16 a h8 c g' e16 f
    g8 g, c c' \mvTr h\pE-\soloE a gis fis %10
    gis e a, a' f d c \hA f
    d e f4 e8 fis g4
    fis8 gis a g f4 e8 e'
    c h a g! fis e d c
    h a << { g' f } \\ { g,4 } >> e'8 d c a %15
    d g, d' d, g g' a g
    fis d h a g e' a, d
    g, g' h, c d d'16 c h8 a
    g g16 fis e8 d cis d a4
    \tempoH-I-VIIDixitB \mvTr d8\fE-\tuttiE h cis a d4 \clef treble << {
      r8 d'' %20
      h e a, d h[ g a]
    } \\ {
      e8 fis %20
    ...
    g \clef "treble_8" e'[ a,] \clef bass fis e a d, g
    c,4 d g, r\fermata \bar "|." %24 finis
  }
}

H-I-VIIDixitBassFigures = \figuremode {
  r4 <[6]>2 <3>4
  <5 2>8 <[\t \t]>4 <6>8 <[7]>4 <9>8 <[5]>
  <6 5>4 <4>8 <_+> r2
  <4>8 <_+> <9> <6> <4> <_+> <6>4
  r <4>8 <4\+> <6>4. q8 %5
  <[6]>2. <6 5>4
  <4>8 <_+>4. <6>8 <[6]>4 <6\\>8
  r4 <_+>2.
  \bo <[6 _!]>2.. <6>16 \bc <[6 5]>
  <4>8 <3>4. <6\\>2 %10
  r1
  <6 5 [_!]>8 <_+> <3> <4> <6 [_!]> <5> <3> <4\+>
  <6> <5> \bo <[_!]> \bc <[6]> <7> <6> <_+>4
  r8 <6\\>4 <4\+>8 <6>2
  \bo <[6]>2 <6> %15
  \bc <[7]>4 <4>8 <_+> <6> <[5]> <_+>4
  <6> q8 <6\\ [_!]>4. <7>8 <7 _+>
  r2. <[6]>4
  r <6\\> <6 5> <4>8 <_+>
  r4 <[6]>2. %20
  r1
  <7>4 q8 <7 _+> <6>4 <6[!]>8 <6>
  r4. <[6]>8 <6>2
  q8 <5> <4> <_+> r2 %24 finis
}
...
H-I-VIILaudateOrgano = {
  \relative c {
    ...
    \mvTr d8\pE-\solo fis cis a' h cis d d,
    a' a, h d e fis d e
    a, a' gis e fis cis d e
    fis gis a \hA gis fis e d cis
    h h' e, fis h, \mvTr h\fE-\tutti cis a! %5
    d cis d d, a' a' fis h
    g e cis d a \mvTr a'\pE-\solo gis e
    cis d e e, a a' cis, a
    fis d' cis a d8. e16 fis8 d
    g fis e d cis d g4 %10
    fis8 fis, ais fis h fis' d h
    fis' cis ais fis h4 h'8 a
    g fis e4 d8 d' cis a
    d d, g h a a, g' fis
    e d cis a' fis h g a %15
    d, d h e a,4 a'8 g
    fis4. e8 d4. cis8
    h g' \mvTr e\fE-\tutti fis d h g a
    fis d' cis a h cis d4
    a8 a' fis h g e cis d %20
    a' d, a4 \tempoH-I-VIILaudateB d8 \clef treble << {
      a'' d4~
      d8 h e d16 e cis8
    } \\ {
      r8 r d, %21
...
H-I-VIILaudateBassFigures = \figuremode {
  r4 <[6]>8 <6> q q <9> <8>
  <4> <_+> <9> <6> <[7] _+>4 <6 5>8 <_+>
  r4 \bo <[6]>4. <6>4 \bc <[_+]>8
  <6> q4 <[6]> <6\\ _!> <6\\>8
  \bo <[4]> \bc <[3]> <6\\ 5> <[_+]>4. <6[!]>4 %5
  r8 <[6]> <9> <8> <4> <_+> <5> <_+>
  <6>4 <6 5>2 \bo <[6]>4
  \bc q <4>8 <_+> r2
  <6>4 q2.
...
H-I-VIILaetatusOrgano = {
  \relative c {
    \clef bass
    \key a \major \time 3/2 \tempoH-I-VIILaetatus
    \mvTr a2\fE-\tutti r4 a' gis e
    a2 r4 a gis e
    a2 r4 fis h2
    r4 gis a e h2
    e r4 e a2 %5
    fis2. d4 e2
    a4 h \mvTr cis\pE-\solo h8 a gis4 fis
    e d cis h a cis
    d cis h a8 gis fis4 gis
    a2 a' gis %10
    fis4 e8 dis cis4 \hA dis e cis'
    a fis h2. a4
    ...
    h, h'4 a! g2
    fis e1
    d2 \clef "treble_8" r4 d'^\aTre cis h %20
    a2 fis e
    a e1
    \clef bass \mvTr a,2\fE-\tutti a'4 cis a e
    cis a a'2 fis
    cis d1 %25
    a2 r4 a' fis h
    gis2 dis e
    cis' a h
    e, \mvTr gis\pE-\solo dis
    cis a h %30
    e gis cis
    fis, d! e
    a2. gis4 fis2
    ...
    cis cis gis1
    cis2. d!4 cis h!
    \mvTr a2\fE-\tutti a'4 a e2
    cis4 a fis'1 %50
    e e2
    fis gis a4 gis
    fis e d1
    e2 \clef "treble_8" \mvTr e'\pE-\solo ^\tweak TextScript.X-offset #0 ^\aTre a,
    gis2. gis4 a2 %55
    e2. e'4 d cis
    h2. h4 a gis
    fis2. fis'4 e d
    cis a e1
    \tempoH-I-VIILaetatusB a2. \mvTr cis4-!\fE-\tuttiE fis,-! a-! %60
    << {
      e'2. gis4 cis, e
    ...
    a gis fis1
    e2 \clef treble << { r4 e'' d! cis8 h } \\ {  e,4 gis fis gis} >>
    \clef bass a,2. cis4 fis, a %65
    gis h e,2. gis4
    fis a d,2. fis4
    e a e1
...
H-I-VIILaetatusBassFigures = \figuremode {
  \bo r1 <[6]>2
  r1 \bc q2
  r1 <_+>2
  r4 <[6]>2. <4>4 <_+>
