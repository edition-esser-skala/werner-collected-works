...
XLIIOrgano = {
  \relative c {
    ...
    f4 b, f2 \noBreak
    b1\fermata \bar "||"
    \tempoXLIIQuiDiceris \mvTr g'2\pE-\solo fis \noBreak %25
    g h,
    c e
    f a,
    b d
    ...
    g4. f!8 es2 \noBreak %35
    d1\fermata \bar "||"
    \tempoXLIIAccende \mvTr b'4.\fE-\soloE c8 d g c, f \noBreak
    b,4 r8 b f'4 g
    f b8 g c f, c4
    f a8 f g4 c, %40
    f8 es! d b c4 f,
    ...
    \tempoXLIIDeoPatri \mvTr f'2\fE-\tuttiE-! d4-! g-! \noBreak
    c,-! f-! << {
      b2
      a4 c f, b
      a2 g4. a8
...
XLIIBassFigures = \figuremode {
  ...
  r1 %15
  <_+>
  \bo <[6]>4. \once \bassFigureExtendersOn \bc q8 r2
  <6 5>8 <[\t \t]>4. <5 4>4 <\t _!>
  r2 r8 <6>4.
  r1 %20
  <[7]>2 <4>4 <3>
  ...
  r4 <[6]> <_-> <6->8 <[\t]>
  r1
  r8 \bo <[6 _-]> <6>4. \bc <[_- _]>
  <6 4>4 <5 3>2.
  r8 <[_-]>4 <6 5>8 <6 4>4 <5 3> %65
  r8 \bo <[6]> <6>2 \bc <[6]>4
  \bo <[6]>4. <_!> \bc <[6]>4
  <6 _->8 <6> <6> <[_-]> <7 _!>4. \once \bassFigureExtendersOn q8
  r4 <5-> <6 5>8 <[\t \t]>4.
  <6 4>4 <5 _+>2. %70
  r1
  r
