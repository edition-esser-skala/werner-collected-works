...
B-XXXIXKyrieSopranoLyrics = \lyricmode {
...
B-XXXIXGloriaSoprano = {
  \relative c' {
    ...
    R1*8 \noBreak %25
    R1\fermata \bar "||"
    \key a \minor \tempoB-XXXIXDomine R1*10 %36
    ...
    c r r2 \noBreak %40
    R1\fermata \bar "||"
    \key c \major \tempoB-XXXIXQuiTollis \mvTr c4\fE^\tutti c c r \noBreak
    c h c8 c c c
    cis4 cis r8 d d d
    dis2 e4 r %45
    cis d! d c!~
    ...
    a( d4 cis8) \tempoB-XXXIXQuiSedes d \mvTr a\fE^\tutti d a %55
    r a\p d a r d\f g d
    r d\p g d r d\f d4~
    d8 d16 d d4\trill d8 d,([ fis)] a
    d1~ \noBreak
    d8 e d4 d r\fermata \bar "||" %60
    \key e \minor \tempoB-XXXIXQuoniam R1*3
...
B-XXXIXGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra, in
...
B-XXXIXCredoSopranoLyrics = \lyricmode {
  Pa -- trem o -- mni -- po --
  ten -- tem, fa -- cto -- rem
  coe -- li, coe -- li et
  ter -- rae,
...
B-XXXIXSanctusSopranoLyrics = \lyricmode {
  San --
...
B-XXXIXAgnusSopranoLyrics = \lyricmode {
  A -- gnus De -- i, qui
