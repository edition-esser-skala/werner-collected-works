...
B-XXXIXKyrieAltoLyrics = \lyricmode {
...
B-XXXIXGloriaAlto = {
  \relative c' {
    ...
    g2 g4 r \noBreak
    R1\fermata \bar "||"
    \key f \major \tempoB-XXXIXLaudamus R1*7 %16
    ...
    f r r2 \noBreak %25
    R1\fermata \bar "||"
    \key a \minor \tempoB-XXXIXDomine R1*14 \noBreak %40
    R1\fermata \bar "||"
    \key c \major \tempoB-XXXIXQuiTollis \mvTr f4\fE^\tutti e f r \noBreak
    e d e r
    r8 b' b b a4 a
    ...
    g4 r g8 h a g
    fis g16([ a)] g4 \tempoB-XXXIXQuiSedes fis r8 \mvTr fis\f^\tutti %55
    ...
    R1\fermata \bar "||"
    \key c \major \tempoB-XXXIXCumSancto R1*2
...
B-XXXIXGloriaAltoLyrics = \lyricmode {
  Et in ter -- ra, in
...
B-XXXIXCredoAltoLyrics = \lyricmode {
  Pa -- trem o -- mni -- po --
  ten -- tem, fa -- cto -- rem
  coe -- li, coe -- li et
  ter -- rae,
...
B-XXXIXSanctusAltoLyrics = \lyricmode {
  San -- ctus,
  san --
  _
  _
...
B-XXXIXBenedictusAltoLyrics = \lyricmode {
  Be --
  ne -- di -- ctus,
  qui ve --
  nit in
...
B-XXXIXAgnusAltoLyrics = \lyricmode {
  A -- gnus De -- i, qui %7
