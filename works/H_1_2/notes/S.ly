...
H-I-IIDixitSoprano = {
  \relative c' {
    ...
    r2 \mvTr h'8\fE^\tutti d c h16([ a)]
    h8. h16 h4 cis8 d16 d d8([ \hA cis)]
    d4 r d8 d d cis
    d d16 d d8 d16 d d8 cis e4~
    e8 cis fis4. e16 fis d4~ %5
    d8 h e d16 e cis8 d d([ \hA cis)]
    d4 d8 c h d16([ c)] h8 a16([ h)]
    c8 h h([ a)] h4 r
    r2 a4 d~
    d8 c h([ a)] g a16([ h)] c4~ %10
    c8 h a([ g)] fis g g([ fis)]
    g4 r r2
    r r4 \mvTr d'~\pE^\solo
    d8 d16 e d8 c c4 h8 e
    e d d([ e16 d] c4. d16[ c] %15
    h8.) h16 h8 h h a a h
    c4. h16 a g8. a16 h4
    r8 e, e' e dis4 e8. e16
    e4( dis) e r
    R1*3 %22
    r8 a, a d h8. c16 d4
    c8 h e d16([ c)] d8 h c4
    h r8 \mvTr h\fE^\tutti e8. dis16 e8 fis %25
    e dis r \hA dis e4. d8
    c cis dis e e4. dis8
    e4 \mvTr h4.\pE^\solo c16([ h)] a8 g
    fis g c4 h8 g d'4~
    d8 e16 d c8 h c h16 a e'4~ %30
    e8 fis16 e d8 cis d \hA cis h4~
    h8 cis h([ ais)] h4 \mvTr d8\fE^\tutti d
    d4 d8 d d4. d8
    d8. cis16 cis8 cis fis d r h
    e cis r a d16([ cis h a] h4) %35
    a8 a a([ gis)] a4 r
    d8 d e e cis8. cis16 d8 d
    h4 a4. h8 a4
    a r r2
    R1*3 %42
    ...
    R1 %70
    r4 r8 d'4 d8 e cis
    d h c d16 c h8 h c d16([ c)]
    h8 a a4 g r
    r a h r\fermata \bar "|." %74 finis
  }
}

H-I-IIDixitSopranoLyrics = \lyricmode {
  Di -- xit, di -- xit
  ...
  Iu -- ra -- vit Do -- mi -- nus %23
  et non poe -- ni -- te -- bit e --
  um: sa -- cer -- dos in ae -- %25
  ter -- num se -- cun -- dum
  or -- di -- nem Mel -- chi -- se --
  dech. Do -- mi -- nus a
  dex -- tris tu -- is, con -- fre --
  git in di -- e i -- rae, con -- fre -- %30
  git in di -- e i -- rae su --
  ae re -- ges. Iu -- di --
  ca -- bit in na -- ti --
  ...
  %70
  et in sae -- cu --
  la, in sae -- cu -- la sae -- cu -- lo -- rum,
  a -- men, a -- men,
  a -- men. %74 finis
}

H-I-IIConfiteborSoprano = {
  \relative c' {
    \clef treble
    \key d \major \time 4/4 \autoBeamOff \tempoH-I-IIConfiteborA
    \mvTr a'4.\pE^\solo d8 cis4 d
    h8 g16([ a)] h8 cis d8. a16 a8 \mvTr fis'\fE^\tutti
    e fis d d d d d([ cis)]
    d4 \mvTr a8\pE^\solo h16([ cis)] d2~
    d8 cis16([ d)] e8 d cis16([ h)] a8 r4 %5
    r2 r8 a h cis
    d4. cis8 h16[ d cis d] e8[ d]
    cis16[ e d e] cis[ h a g] fis8. e16 e4
    d8 \mvTr d'\fE^\tutti e d d d d([ cis)]
    d4 r r2 %10
    R1*6 %16
    r4 \mvTr d\fE^\tutti d d8 d
    dis dis dis dis dis4 dis8 dis
    h h h([ a)] h4 r
    h4. h8 c4 c8 c %20
    c4. c8 h2~
    h8[ c16 h] a8 g fis g16 g g8 fis
    g4 r r2
    r4 \mvTr h\pE^\solo e4. d16 e
    cis!4 d r a8 d %25
    h cis16([ d)] cis8 h ais?16([ gis?)] fis8 r cis'
    cis8. cis16 cis4 r8 cis fis ais,
    h4 cis d8 h16 a gis8 fis
    eis([ d')] cis h a4. gis16 gis
    fis4 r r2 %30
    R1*4
    r2 \mvTr e'4.\fE^\tutti e8 %35
    cis a16 h cis8 d e4. d8
    cis[ h a] d4 cis8[ h \once \tieDashed e]~
    ...
    e4 r r2
    r cis
    h8 cis16([ d!)] e8 e e4 d8 d
    cis d16([ e)] fis4. h,8[ e d] %45
    cis d4 cis8 d4 r
    r8 h h h e4. d8
    cis4 d e8 a,16 a a8([ gis)]
    a a d16([ cis)] d8 r h16 h e([ d)] e8
    r cis16 cis fis4~ fis16[ e d cis] d4~ %50
    d8 e d([ cis)] d4 r
    R1 \noBreak
    R\fermata \bar "||"
    \tempoH-I-IIConfiteborB R1*8 %61
    r2 r8 \mvTr d4\pE^\solo h8
    e d e c d4. \hA c16 h
    c8 d h \hA c16 h h4 a8 a
    a h16 c d8 \hA c h4 e8 d %65
    cis4 d8 g, fis4. e8
    d4 r r2
    R1*6 %73
    r4 d'8^\aTreE d cis cis cis cis
    h8. h16 h8 h a a h a %75
    a4( gis) a \mvTr d8\fE^\tutti c?
    h8. h16 h4 a4. a8
    g4. a8 a( d4 cis8)
    d a[ d cis] h[ d e d]
    cis[ e fis e] d4 r %80
    ...
    cis4 d2 cis4
    d r8 d16([ c?] h8) h r h( %85
    cis d4 cis8) d4 r\fermata \bar "|." %86 finis

  }
}

H-I-IIConfiteborSopranoLyrics = \lyricmode {
  Con -- fi -- te -- bor
...
H-I-IIBeatusSoprano = {
  \relative c' {
    ...
    R2.*39 %39
    r4 \mvTr cis'\fE^\tutti cis8 cis %40
    d4 d8 d d d
    ...
    fis4 r r
    R2.*9 %63
    r4 r \once \tieDashed \mvTr e'~\pE^\solo
    e e dis %65
    e h8 cis16([ dis)] e8 d
    cis2 h4~
    h8 cis a4. a8
    ...
    R2. %70
    fis4 h8([ a)] gis fis
    gis([ a16 h] cis8[ h)] a([ gis)]
    a4. h16([ cis)] d8 cis
    cis8. h16 h4 r
    e,4. fis16([ gis)] a8 gis %75
    fis4.( gis16[ a] h8[ a])
    gis fis' e4. d8
    cis h16([ a)] h4. h8
    a4 r r
    ...
    R2. \noBreak
    R\fermata \bar "||"
    \time 4/4 \tempoH-I-IIBeatusB R1*5 %119
    r2 r4 \mvTr e'\pE^\solo %120
    e4. d16 e cis8 a r16 \mvTr cis\fE^\tutti cis cis
    d8 d r4 a8 a16 a h8 cis
    d16([ cis)] d8 r4 h8 h16 h cis8 d
    e16([ d)] e8 r4 cis8 cis16 cis d8 e
    fis4. e8 e e16([ d)] cis8 cis %125
    cis h r4 r \tempoH-I-IIBeatusC h~
    h8 gis cis4. h16 cis a4~
    a8[ h16 cis] h8 a gis8.([ fis16)] e4
    r a4. fis8 h a16 h
    gis8 h cis4. a8 d4~ %130
    d cis8 cis4 a8 d4~
    d8 cis16 d e8 d cis4 h8 a \noBreak
    gis( a4 gis8) a4 r\fermata \bar "||"
    \tempoH-I-IIBeatusD R1*9 %142
    r4 \mvTr e'8\pE^\soloE e cis a cis dis
    e8. e16 e4 r8 cis fis e
    d!4 d r8 h e d %145
    cis2 h
    r r4 \mvTr a8\fE^\tutti a
    h h16 a h8 cis d4. d8
    cis h h4 cis e
    e8 e([ fis cis)] d d([ e h)] %150
    cis4 r r e
    ...
    h8[ a16 gis] a2 gis4
    a r r2
    r4 h cis r\fermata \bar "|." %165 finis
  }
}

H-I-IIBeatusSopranoLyrics = \lyricmode {
  Glo -- ri -- a, %40
  glo -- ri -- a et di --
  vi -- ti -- ae in do --
  mo e --
  ...
  Pec -- %120
  ca -- tor vi -- de -- bit et i -- ra --
  sce -- tur, den -- ti -- bus su -- is
  fre -- met, den -- ti -- bus su -- is
  fre -- met, den -- ti -- bus su -- is
  fre -- met, fre -- met et ta -- %125
  be -- scet: De --
  si -- de -- ri -- um pec --
  _ ca -- to -- rum,
  de -- si -- de -- ri -- um
  pec -- ca -- to -- _ _ %130
  rum, de -- si -- de --
  ri -- um pec -- ca -- to -- rum per --
  i -- bit.

  si -- cut e -- rat in prin -- %143
  ci -- pi -- o et nunc et
  sem -- per, et nunc et %145
  sem -- per
  et in
