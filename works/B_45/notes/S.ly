...
B-XLVKyrieSopranoLyrics = \lyricmode {
  Ky -- %3
  ri -- e __
  e -- %5
  lei -- _ _ _
...
B-XLVGloriaSopranoLyrics = \lyricmode {
  Glo -- ri --
  a in ex --
  cel -- sis De --
  o. Et in
...
B-XLVCredoSopranoLyrics = \lyricmode {
  Cre --
...
B-XLVSanctusSopranoLyrics = \lyricmode {
  San -- _ %7
  ctus, san --
  ctus Do --
  mi -- nus De -- %10
...
B-XLVBenedictusSopranoLyrics = \lyricmode {
  Be -- ne --
  di -- ctus, qui
  ve --
  nit,
...
B-XLVAgnusSopranoLyrics = \lyricmode {
  Qui %2
  tol -- lis pec -- ca -- ta
  mun -- di: Mi -- se --
  re -- re no -- %5
