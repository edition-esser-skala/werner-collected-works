...
B-XLVKyrieBassFigures = \figuremode {
  r4 <_+>2.
  r1
...
B-XLVGloriaOrgano = {
  \relative c {
    ...
    \tempoB-XLVQuoniam \mvTr f8\pE-\solo f' e d c b a g \noBreak %60
...
B-XLVGloriaBassFigures = \figuremode {
  r1
  r2 \bo <[6]>
  \bc q <6>4 q
  r1
...
B-XLVCredoOrgano = {
  \relative c {
    ...
    f4. f8 f f \noBreak
    f4 r r\fermata \bar "||"
    \time 4/4 \tempoB-XLVEtIncarnatus \mvTr d'4\pE-\solo r d r \noBreak %50
    cis a d r
    c r b r
    h8\fE h h h a4 g
    f r8 d'\pE e4 c!
    ...
    a2 r\fermata \bar "||"
    \clef "treble_8" \tempoB-XLVEtVitam \mvTr f'2\fE-\tutti a \noBreak
    \clef bass << { c } \\ { c, } >> e
    f4 a b b, %125
    f f' e c
    a f b8 b' d, b
...
B-XLVCredoBassFigures = \figuremode {
  r2.
  <[6]>
  r
  <6>4 q2
...
B-XLVSanctusBassFigures = \figuremode {
  r\breve
  r
  r
  r
...
B-XLVBenedictusBassFigures = \figuremode {
  r2. <6>4
  <6 5>2 <5>4 <6>
  <6 5>2 <5 2>4 <\t \t>
  <6>2 <4>4 <3>
...
B-XLVAgnusBassFigures = \figuremode {
