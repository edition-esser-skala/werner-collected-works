...
B-LIGloriaAlto = {
  \relative c' {
    ...
    \time 4/4 \tempoB-LIDomine b8 \mvTr f'\fE^\tutti f f f f f f \noBreak %30
    f f r4 r f8 d
    ...
    c2 d4 r \noBreak %40
    R1\fermata \bar "||"
    \tempoB-LIQuiTollis r4 \mvTr g\pE^\solo es8.([ f16)] g8 g \noBreak
    f f f4.( es8) es4
    R1*3 %46
...
B-LIGloriaAltoLyrics = \lyricmode {
  Et in ter -- ra, ter -- ra
  pax,
  pax ho -- mi -- ni --
  bus
...
B-LISanctusAlto = {
  \relative c' {
    ...
    es d4. d8 \noBreak %10
    d4 r r
    \tempoB-LIPleni r8 g g g f! f16 f \noBreak
    f8 f r4 r
    R2.*2 %15
    r8 d f d g a
    b16([ a)] b8 r4 r
...
B-LISanctusAltoLyrics = \lyricmode {
  San -- ctus,
  san -- ctus,
  san -- ctus,
  san -- ctus Do -- mi --
...
B-LIBenedictusAltoLyrics = \lyricmode {
  Be -- ne -- %2
  di -- ctus, qui
  ve -- nit
  in __ %5
...
B-LIAgnusAlto = {
  \relative c' {
    ...
    \tempoB-LIDona \mvTr b4.\fE^\tuttiE d8 d[ c] es4~ \noBreak
    es8 d f4.( es8) g4
