...
B-LIGloriaOrgano = {
  \relative c {
    ...
    c4. b8 a! g \noBreak
    f b f' es f f,
    \time 4/4 \tempoB-LIDomine b \mvTr b'\fE-\tutti b f d b b' f \noBreak %30
    d b r4 r b8 g'
    e f c c, f f' f c
    a f f' c a f r d'
    cis d a' a, d d' b fis
    ...
    b4 r r2\fermata \bar "||"
    \tempoB-LIQuiTollis \mvTr h2\pE-\solo c \noBreak
    d es8 es es es
    e2 f8 f f f
    fis2 g %45
    ...
    \tempoB-LIQuoniam \mvTr g8\pE-\soloE g' fis d b es16 d es8 b \noBreak
    c4 d8 d, g g' a f
    b f d b es d c es
    f4 r f r %60
    ...
    \clef treble \tempoB-LICumSancto \mvTr b''4\fE-!-\tuttiE d4.-! c16-! b-! a8-! g-! \noBreak
