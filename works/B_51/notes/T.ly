...
B-LIGloriaTenore = {
  \relative c' {
    ...
    a4 r r
    R2.*7 %29
    \time 4/4 \tempoB-LIDomine r8 \mvTr b\fE^\tutti b a b b b a \noBreak %30
    b b r4 r b8 b
    ...
    f2 f4 r \noBreak %40
    R1\fermata \bar "||"
    \tempoB-LIQuiTollis r2 \mvTr g4\pE^\solo es'~ \noBreak
    es8[ d] d f b,4 b
    R1*3 %46
    b2 b8([ a)] a a
    b4 b g! e8 f
    c'4 c r2
    R1*2 %51
    \tempoB-LIQuiSedes r8 \mvTr c\fE^\tutti f c a f r a
    b b r4 r8 d es([ d)]
...
B-LISanctusTenore = {
  \relative c' {
    ...
    c a4. a8 \noBreak %10
    g4 r r
    \tempoB-LIPleni r8 d' es es c c16 c \noBreak
    d8 d r4 r
    R2.*2 %15
    r8 b d b es c
    d16([ c)] d8 r4 r
...
B-LIBenedictusTenore = {
  \relative c' {
    ...
    a4 g8[ fis] g4 \noBreak
    fis2.\fermata \bar "||"
    \key b\major \time 4/4 \tempoB-LIOsanna R1 \noBreak
