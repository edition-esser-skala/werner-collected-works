...
I-I-XXVI-Tenore = {
  \relative c' {
    \clef "treble_8"
    \key g \major \time 4/4 \tempoI-I-XXVI \autoBeamOff
    \mvTr g4~\pE^\solo g16[ h a g] d'8 a h fis
    ...
    b16[\trill a] \hA \once \stemUp b4. a16[\trill g] a4. %10
    g16[\trill f?] g4. f16[\trill e] \hA f4.
    e4 r a8. a16 d8 c!
    ...
    fis! d r4 r8 h'4 c8
    d a h fis g4. g8
    fis cis' d \hA cis16([ h)] h8.[ \hA cis16] cis4\trill
    h r r2
    R1 %20
...
I-I-XXVI-TenoreLyrics = \lyricmode {
  Al -- _ ma Re -- dem --
