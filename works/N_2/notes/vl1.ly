...
N-IIViolinoI = {
  \relative c' {
    ...
    h g'!4 e16 cis d8[ \appoggiatura { a16[ \hA g] } a8 \appoggiatura { a16[ g] } a8 \appoggiatura { a16[ g] } a8]
    ...
    \key d \minor \time 3/8 \tempoN-IIb \newSpacingSection
      ...
      a,8.\p b16 a8 \noBreak
    \parOn g-\parenthesize-! \parOff e-\parenthesize-! r %25
    f16 g64( a b c) d8 f,
    f-! e-! r
    ...
    f( c) a'( f) f([ c) a'( f)] f( a) c( a)
    f( a) c( f) a16.[\trill g64 a] b16.\trill a64 g %45
    f32( a,) c( f) a16.[\trill g64 a] b16.\trill a64 g
    f32( c) a'( f) f([ c) d( c)] b16.\trill a64 g
    f32( c') a'( f) f([ c) d( c)] b16.\trill a64 g
    <f a>16(-. q-. q-. q-. q-. q-.)
    q(-. q-. q-. q-. q-. q-.) %50
    << { a32[ b64_( c d e f g)] } \\ { f,8 } >> a'8[ c,]
    cis32.\trill d64( e f g a) b8[ cis,]
    d16.\trill f64 e d16[ c b a]
    r f' r f r f
    r f,\pp f f f32(\trill e) f16 \noBreak %55
    e4 r8\fermata \bar "||"
    \key d \major \tempoN-IIc
      d''4\fE \tuplet 3/2 8 { d16 cis h } \noBreak
    ...
    \tuplet 3/2 8 { fis16 e fis g fis g } a8
    \tuplet 3/2 8 { e16 d e f e \hA f } g8
    \tuplet 3/2 8 { f16 e \hA f g \hA f g } \sbOff a8~
    a g f
    f\trill e r %70
    a,\p g f
    f\trill e r
    ...
    a,( a') gis( a) a,[( a') \hA gis( a)] a,( a') \hA gis( a)
    a,( a') gis( a) a,[( a') \hA gis( a)] a,( a') \hA gis( a)
    a,16[ cis'-! cis-! cis]-! d16. cis64 h %95
    ...
    fis( a) g( a) h( g)
    a( h) a( h) g( a)
    fis16.\trill e64( fis) g16.[\trill e64( fis)] g16.\trill fis64 e
    d16 a a a h16.[\trill a64 g] %105
    fis16.\trill e64( fis) g16.[\trill e64( fis)] g16.\trill fis64 e
