...
N-IIViolinoII = {
  \relative c' {
    ...
    fis( g) a( fis) h( g) fis( e) d8(-. d-.) d(-. d-.) %5
    ...
    \sbOn \tuplet 3/2 8 { cis16 h cis } a cis \sbOff cis( h) e,( cis') a( cis) e( fis) d( h) e,( cis')
    ...
    h d h h d h gis h \hA gis gis h \hA gis } << { a8 } \\ { \tuplet 3/2 8 { \sbOn a,16 cis a a cis a a cis a a cis a } } >>
    \tuplet 3/2 8 { fis a fis fis a fis gis h \hA gis gis h \hA gis } \sbOff a4 r8 a %15
    ...
    fis'( a,) fis( a) d( a') fis( d) <fis a, d,>4 r\fermata \bar "||"
    ...
    a16( c,) g'( c,) f( c) %40
    f( e) e8 r
    f,8~ f16 a32( f) c'16 a32( c)
    f,16( c') a( f') c( a')
    a,( c) a( f') c( a')
    a,( c) c16.[\trill b64( c)] d16.\trill c64( b) %45
    a16( c) c16.[\trill b64( c)] d16.\trill c64( b)
    a16( f) a( c) g16.[\trill f64( e)]
    f16( f') a,( c) g16.[\trill f64 e]
    \slurDashed <f a>16(-. q-. q-. q-. q-. q-.)
    q(-. q-. q-. q-. q-. q-.) \slurSolid %50
    q8 r16 c' a c
    g8 r16 g b g
    f16. f'64 e d16[ c! b a]
    r d r d r d
    r d,\pp d d d d \noBreak %55
    cis4 r8\fermata \bar "||"
    ...
    fis4 g8
    r e g
    fis16([ a)] \tuplet 3/2 8 { \sbTOn a g a a g a } %85
    d8 h, d'
    ...
    a,( a') gis( a) a,[( a') \hA gis( a)] a,( a') \hA gis( a)
    a,( a') gis( a) a,[( a') \hA gis( a)] a,( a') \hA gis( a)
    a,16[ e''-! e-! e-!] fis16.\trill e64 d %95
    ...
    d( fis) e( fis) g( e)
    fis( g) fis( g) e( fis)
    d[ a a a] h16.\trill a64 g
    fis16.\trill e64( fis) fis16.[\trill e64( fis)] g16.\trill fis64( e) %105
    d16[ a a a] h16.\trill a64( g)
    a16( fis') g( e) cis( e)
    d( fis) g( e) cis( e)
    d( fis) g( e) cis( e)
    \stemUp <d a' fis'>16 a''32 a, <d, a' fis'>16[ a''32 a,] <d, a' fis'>16 a''32 a, \stemNeutral %110
    d16( a') fis( d) a32([ d) fis,( a)]
    d,4.~
