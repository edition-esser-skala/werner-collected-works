...
B-XLVIIIGloriaBasso = {
  \relative c {
    ...
    \tempoB-XLVIIIGlorificamus R1*3 %24
    ...
    R1\fermata \bar "||"
    \tempoB-XLVIIICumSancto \mvTr d2\fE^\tutti a'4 fis \noBreak
    h a8([ g)] fis8[( d')] cis([ h)]
...
B-XLVIIICredoBasso = {
  \relative c {
    ...
    d([ d')] h g a4( a,) \noBreak %20
    d2 r\fermata \bar "||"
    \time 4/4 \tempoB-XLVIIIEtIncarnatus R1*6 %27
...
B-XLVIIISanctusBasso = {
  \relative c {
    ...
    h[ a] gis4 r e~ \noBreak %5
    e e e4. e8
    \tempoB-XLVIIIPleni a,8 a' fis cis d d r fis \noBreak
    h, h r d g, g r e'
    a4 fis8[ d] h'4 g8[ e]
