...
B-XLVIIIGloriaSoprano = {
  \relative c' {
    ...
    R1 \noBreak
    R\fermata \bar "||"
    \tempoB-XLVIIILaudamus r8 \mvTr d\pE^\solo d16([\trill c)] h([\trill a)] g8 d'4 g8
    ...
    \tempoB-XLVIIIGlorificamus d8 a d d h16[ cis d h] e8.[\trill d16]
    ...
    \tempoB-XLVIIIQuoniam \mvTr g8.\pE^\solo g16 g8 d' h fis g a \noBreak
    h a r d h a r d
...
B-XLVIIISanctusSoprano = {
  \relative c' {
    ...
    a8( d4) cis8 h4. h8
    \tempoB-XLVIIIPleni cis cis d e fis fis r cis \noBreak
    d d r d d d h[ e]~
...
B-XLVIIIAgnusSoprano = {
  \relative c' {
    ...
    R1*5 \noBreak %20
    R1\fermata \bar "||"
    \tempoB-XLVIIIDona \mvTr d4.\fE^\tutti d8 d4 d, \noBreak
