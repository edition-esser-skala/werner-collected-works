...
B-XXVIIIKyrieBassFigures = \figuremode {
  r1.
  r2 <5 4>4 <6 3> <10 5>2
  <5>4 <6> <5> <6> <5> <6>
  <5> <6> \bo <[5]> \bc <[6]> <6 5>2
...
B-XXVIIIGloriaOrgano = {
  \relative c {
    ...
    g d h' g d' d, fis d \noBreak %35
    g d h g d' d, r4
    \clef "treble_8" \time 3/4 \tempoB-XXVIIIAmen
    << {
      d''4 r8 d4 h'8 \noBreak %37
      r e, c a' d, d
      h g' r e fis g~
...
B-XXVIIIGloriaBassFigures = \figuremode {
  r1
  <6 5>4 <4>8 <_+>2 <6>8
  <5> <6> <5> <6> <5> <6> <5> <6>
  r2 <7 _+>4 <4>8 <_+>
...
B-XXVIIICredoBassFigures = \figuremode {
  r2 <5>4 <6>2.
  r1 <_+>2
  <5[+]>4 <[6]>2. <4>4 <_+>
  r2 <5>4 <6> <5> <6[!]>
...
B-XXVIIISanctusOrgano = {
  \relative c {
    ...
    g d2 \noBreak
    g, r4\fermata \bar "||" %20
    \clef "treble_8" \time 3/2 \tempoB-XXVIIIOsanna \newSpacingSection
    << {
      s2 d'' fis4 d \noBreak
      g2 r4 e a fis
      d g
...
B-XXVIIISanctusBassFigures = \figuremode {
  r2 <6>4
  r2 q4
  r2 q4
  r2 <_+>4
...
B-XXVIIIBenedictusBassFigures = \figuremode {
...
B-XXVIIIAgnusOrgano = {
  \relative c {
    ...
    a1 \noBreak
    d2 r\fermata \bar "||"
    \clef "treble_8" \time 3/2 \tempoB-XXVIIIDona \newSpacingSection
...
B-XXVIIIAgnusBassFigures = \figuremode {
  r2 <5 4>4 <\t _!>
  r2 <5 4>4 <\t 3>8 <6\\ \t>
  <5>4. <6\\> <5>4
  <7 5 [_+]>2 <_+>
