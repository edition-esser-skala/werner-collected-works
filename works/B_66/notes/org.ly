...
B-LVIBenedictusOrgano = {
  \relative c {
    ...
    \time 4/4 \tempoB-LVIOsanna
      \mvTr d'2\fE-\tuttiE a'4. g8 \noBreak
    f4 cis d2
    a1\fermata
    a'2-\tasto gis4-! e8-! fis-! %25
    g4-! g-! fis-! d8-! e-!
    << {
      d'2 cis4 a8 h %27
      c2 h4 g8 a
    ...
    g4 d8 e f4. g8
    a2 d, %35
    \clef "treble_8" d'^\critnote cis4 a8 h
    \clef bass a2 gis4 e8 fis
    g2 fis4 d8 e
    f4 f e8 d c4
...
B-LVIAgnusOrgano = {
  \relative c {
    ...
    a fis4 g %15
    d'2 g,
    \clef "treble_8" g'4.^\aTreE g8 d'2
    h4 c fis, g \noBreak
    es2 d\fermata \bar "||"
    \clef bass \tempoB-LVIDona
      d2 e \noBreak %20
    f g
    a b
    a4 a d,2
