...
B-LIIGloriaViolinoI = {
  \relative c' {
    ...
    \tempoB-LIIQuoniam a16.\p\trillE a,32 a8 r4 c'16.\trill c,32 c8 r4 \noBreak %60
    ...
    \tempoB-LIIInGloria r2 r8 g'4\fE g8 \noBreak
...
B-LIICredoViolinoI = {
  \relative c' {
    ...
    a4 r r\fermata \bar "||"
    \time 4/4 \tempoB-LIIEtIncarnatus r2 r8 a16(\p d) b( d) a( d) \noBreak %50
    ...
    R1*5 \noBreak %121
    R1\fermata \bar "||"
    \tempoB-LIIEtVitam r8 f16\fE g a8 g f c a f' \noBreak
...
B-LIIAgnusViolinoI = {
  \relative c' {
    ...
    \tempoB-LIIDona r2 r8 b,!\fE a gis \noBreak
