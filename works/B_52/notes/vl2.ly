...
B-LIIGloriaViolinoII = {
  \relative c' {
    ...
    \tempoB-LIIQuoniam f16.\p\trill f,32 f8 r4 e'16.\trillE c,32 c8 r4 \noBreak %60
    ...
    \tempoB-LIIInGloria r8 d4\fE d8 g, g c16 b c8 \noBreak
    a f r4 r2
...
B-LIICredoViolinoII = {
  \relative c' {
    ...
    f4 r r\fermata \bar "||"
    \time 4/4 \tempoB-LIIEtIncarnatus r2 r8 f\p g f \noBreak %50
