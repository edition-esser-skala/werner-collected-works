...
B-LIIGloriaTenore = {
  \relative c' {
    ...
    d2 c \noBreak
    c c\fermata \bar "||"
    \tempoB-LIIQuoniam \mvTr f,2\pE^\solo g \noBreak %60
    a4 a b a
    g2 f4 r
    R1*3 %65
    ...
    b4( g) a r \noBreak
    R1\fermata \bar "||" %70
    \tempoB-LIIInGloria r8 \mvTr d\fE^\tutti d d16 d g,8 g c4
    a r8 d b4 c
...
B-LIICredoTenore = {
  \relative c' {
    ...
    a2 r4 \noBreak
    R2.\fermata \bar "||"
    \time 4/4 \tempoB-LIIEtIncarnatus R1*15 \noBreak %64
    R1\fermata \bar "||" %65
    ...
    c4. h?16[ a] c4 h?\trill \noBreak
    a2 r\fermata \bar "||"
    \tempoB-LIIEtVitam \mvTr f2\fE^\tutti a \noBreak
    c r4 c
    a c d4. d8 %125
    c4 a( g4.\trill f16[ g])
    a2 r
...
B-LIIBenedictusTenoreLyrics = \lyricmode {
  Be -- ne -- %3
  di -- ctus, qui
  ve -- %5
  nit,
