...
D-II-VIIViolinoII = {
  \relative c' {
    ...
    b,4 r r
    R2.*3
    d4\fE es!8 f \once \tieDashed g4~ %70
    g fis8 g a4
    d, e8 fis fis4
    g d4. es16 f
    g2 g4
    ...
    a8 f r f'16 d es c d b c a f' d
    es c d b c a b g a f g a b c d es
    ...
    b g d b g g'^\critnote a b a b a g f g f es
    ...
    d f f f g e h d cis8 a r a'16 f
    g e f d e cis a' f g e f d \hA e cis d h
    cis a h \hA cis d e f g a8 h16 cis d8 f,
    g d' e, cis' d16 a a a a a a a %120
    d f, f f f f fis fis g d b d g, b d g
    es! c es g c g es c f f, f f f f f f
    f f' d f c f b, f' a, f' d f c f b, f'
