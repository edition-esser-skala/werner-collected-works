...
B-XLVIGloriaOrgano = {
  \relative c {
    ...
    g4 a h c
    d8 h e4 \tempoB-XLVIQuiSedes d \clef bass r8 \mvTr d,\fE^\tuttiE %55
    g d r d\p g d r g\f
    c g r g\p c, g r g'\f
    fis d h g d'4 r
    r8 g, h d g g, h d \noBreak
    g c, d d, g4 r\fermata \bar "||" %60
    \key e \minor \tempoB-XLVIQuoniam \mvTr e8\fE-\solo e' fis dis e g16 fis e8 d \noBreak
    ...
    \key c \major \tempoB-XLVICumSancto r8 \mvTr g'-!\fE-\tuttiE g-! g-! << {
      r c c c \noBreak
      d4 a r8 h h a16 h
    } \\ {
      a4 e
...
B-XLVIBenedictusOrgano = {
  \relative c {
    \clef bass
    \key c \major \time 4/4 \tempoB-XLVIBenedictus
