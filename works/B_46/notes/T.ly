...
B-XLVIGloriaTenore = {
  \relative c' {
    ...
    R1*3 \noBreak %40
    R1\fermata \bar "||"
    \key c \major \tempoB-XLVIQuiTollis \mvTr a4\fE^\tutti g a r \noBreak
    g g g r
    r8 e' e e e([ d)] d4
    r8 c! c c c([ h!)] h4 %45
    R1
    ...
    g4 a h c
    d8 h e4 \tempoB-XLVIQuiSedes d r8 \mvTr d\fE^\tutti %55
    h d r d\p h d r h\f
    ...
    R1\fermata \bar "||"
    \key c \major \tempoB-XLVICumSancto r2 r8 \mvTr c\fE^\tutti c c \noBreak
...
B-XLVICredoTenore = {
  \relative c' {
    ...
    a2~ a\trill \noBreak
    gis r\fermata \bar "||"
    \tempoB-XLVIEtVitam r2 \mvTr c\fE^\tutti \noBreak
    e4( c) h4. c8
    d4 h a a8 h %155
    c([ d] e[ d16 c)] d4 r
    R1
...
B-XLVISanctusTenore = {
  \relative c' {
    ...
    R1\fermata \bar "||" %25
    \time 4/4 \tempoB-XLVIOsanna r2 \mvTr c\fE^\tutti \noBreak
    e4. e8 c4 f
