    ...
    \score {
      <<
        \new ChoirStaff <<
          \new Staff {
            \set Staff.instrumentName = "S"
            \new Voice = "Soprano" { \dynamicUp \B-XLVIBenedictusSoprano }
          }
          \new Lyrics \lyricsto Soprano \B-XLVIBenedictusSopranoLyrics
          ...
          \new Staff {
            \set Staff.instrumentName = "B"
            \new Voice = "Basso" { \dynamicUp \B-XLVIBenedictusBasso }
          }
