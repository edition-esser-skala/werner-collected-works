...
B-XLVIIKyrieAltoLyrics = \lyricmode {
...
B-XLVIIGloriaAltoLyrics = \lyricmode {
  Et in ter -- ra, in
  ter -- ra, in ter -- ra
  pax, pax, pax, pax,
  pax ho -- mi -- ni -- bus
...
B-XLVIIGratiasAlto = {
  \relative c' {
    \clef treble
    \key d \dorian \time 3/4 \autoBeamOff \tempoB-XLVIIGratias
...
B-XLVIIGratiasAltoLyrics = \lyricmode {
  Gra -- ti -- as %32
  a -- gi -- mus
  ti -- bi, a --
  gi -- mus %35
...
B-XLVIIQuiTollisAltoLyrics = \lyricmode {
  Qui tol -- %79
  lis pec -- ca -- ta %80
  mun -- di:
...
B-XLVIICumSanctoAltoLyrics = \lyricmode {
...
B-XLVIICredoAltoLyrics = \lyricmode {
  Pa -- trem o --
  mni -- po --
  ten -- tem, fa -- cto -- rem
  coe -- li,
...
B-XLVIIEtResurrexitAltoLyrics = \lyricmode {
  Et re -- sur -- %88
...
B-XLVIISanctusAltoLyrics = \lyricmode {
  San -- ctus, %2
  san -- ctus, san --
  _ _ _
  _ _ _ _ %5
...
B-XLVIIAgnusAltoLyrics = \lyricmode {
  A -- gnus
  De -- i, qui
  tol -- lis pec --
  ca -- ta
