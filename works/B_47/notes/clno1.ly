...
B-XLVIIKyrieClarinoI = {
  \relative c' {
    ...
    \time 6/8 \tempoB-XLVIIChriste \newSpacingSection
      R2.*28 \noBreak %48
    R2.\fermata \bar "||"
    \time 4/4 \tempoB-XLVIIKyrieFuga \newSpacingSection
      R1*13 %62
    r2 r8 d'\fE d d
...
B-XLVIISanctusClarinoI = {
  \relative c' {
    \clef treble
    \key c \major \time 4/4 \tempoB-XLVIISanctus
    R1*7 %7
    \tempoB-XLVIISanctusB r8 g''4\fE g8 g4 g8 g \noBreak
    a a r4 a a8 a
    g4. g8 \pa e d c e %10
    d16 g,32 g g16 g g g32 g g16 g g4 \pd r
    r8 e'4 e8 r a4 a8 \noBreak
    g g g8. g16 g4 r\fermata \markFiatMarche \bar "||"
    \tempoB-XLVIIPleni r8 c,\fE e8.\trillE d32 c g'8 d g8.\trill a32 h \noBreak
