...
B-XLVIIKyrieSopranoLyrics = \lyricmode {
...
B-XLVIIGloriaSopranoLyrics = \lyricmode {
  Et in ter -- ra, in
  ter -- ra, in ter -- ra
  pax, pax, pax, pax,
  pax ho -- mi -- ni -- bus
...
B-XLVIIQuiTollisSopranoLyrics = \lyricmode {
  Qui tol -- lis pec -- %79
  ca -- ta, pec -- ca -- ta %80
  mun -- di:
...
B-XLVIICumSanctoSopranoLyrics = \lyricmode {
  Cum San -- cto %132
...
B-XLVIICredoSopranoLyrics = \lyricmode {
  Pa -- trem o --
  mni -- po --
  ten -- tem, fa --
  cto -- rem
...
B-XLVIIEtIncarnatusSoprano = {
  \relative c' {
    \clef treble
    \key c \dorian \time 4/4 \autoBeamOff \tempoB-XLVIIEtIncarnatus
...
B-XLVIIEtIncarnatusSopranoLyrics = \lyricmode {
...
B-XLVIIEtResurrexitSoprano = {
  \relative c' {
    ...
    R1*5 \noBreak %116
    R1\fermata \bar "||"
    \tempoB-XLVIIEtVitam \mvTr c2\fE^\tuttiE c4 c,8 c' \noBreak
...
B-XLVIIEtResurrexitSopranoLyrics = \lyricmode {
  Et re -- sur -- %88
...
B-XLVIISanctusSopranoLyrics = \lyricmode {
  San -- _ _ _ %3
  _ ctus, san -- _
  _ _ _ %5
  _ _
...
B-XLVIIAgnusSopranoLyrics = \lyricmode {
  A -- gnus
  De -- i, qui
  tol -- lis pec --
  ca -- ta, pec --
