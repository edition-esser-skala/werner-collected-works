...
B-XXXVKyrieBassFigures = \figuremode {
  ...
  <9 5 _+> <8 6 \t> \bo <6 [_+ _]> \bc <7 [5\+ _+]> <9\\> <8> <6 4>4
  <5 3> <6> <6\\ 5> <[5\+] _+>
  r4 <[6 _+]> <_!>8 <4\+> <6> <6\\>
  r4 <[6]>2.
  r4 <7> q q %20
...
B-XXXVQuiTollisOrgano = {
  \relative c {
    ...
    \mvTr h~\pE-\solo h
    c cis
    d \clef "treble_8" \mvTr d'\pE-\solo-\aTre
    g, c4 e, %125
    f a b4. g8
    e4 f c r
...
B-XXXVCumSanctoOrgano = {
  \relative c {
    ...
    c8 c16 d e8 d16 c << {
      ...
      r c4 e8 \hA fis,16 e \hA fis8 a16 g a8
      r h4 d8 e, a4 c8
      d, h' a4
    } \\ {
      h,8 e~ e16 d c h
...
B-XXXVEtIncarnatusOrganoSolo = {
  \relative c' {
    \clef treble
    \key f \major \time 3/4 \tempoB-XXXVEtIncarnatus
...
B-XXXVEtResurrexitOrgano = {
  \relative c {
    ...
    e c g'2 g,
    c r r
    \mvTr a4\pE-\solo-\aTre \clef "treble_8" a' a f' d e
    a, a' a a, f g! %100
    c, c'2 g4 a h
...
B-XXXVSanctusOrgano = {
  \relative c {
    ...
    << {
      ...
      \oneVoice e4-! c-! \voiceTwo r8 g'16 f e d c h
      a2 g8 g'4 f8 %30
    } >>
...
B-XXXVBenedictusOrgano = {
  \relative c {
    ...
    \mvTr a4\pE-\solo h8 gis a16. a'32 e16. c32 a8 a'
    f d h g c4 cis8 a'
    f d h g' e a d, g
    c, a' f g e f d e
    c a' gis e a d, e e, %5
    ...
    a, a' f g c, c' a f
    e f g g, c4 g'8 gis
    a f d dis e8. fis16 gis8 e %10
    a16 g f e d8 d' g, g, c c'
    f, f, h h' e, e, a a'
    gis e r \hA gis a d, e e,
    a a' f g e f d e
...
B-XXXVAgnusOrgano = {
  \relative c {
    ...
    g'4-\tutti e d2 %5
    c4 f c2
    f,4 r \clef "treble_8" \mvTr d''2\pE-\solo-\aTre
    d d4 r
    r8 c! c c b2
