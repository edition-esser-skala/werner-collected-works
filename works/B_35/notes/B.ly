...
B-XXXVKyrieBasso = {
  \relative c {
    ...
    c4 r r2\fermata \bar "||"
    \key a \minor \tempoB-XXXVChriste R1*5 %38
...
B-XXXVKyrieBassoLyrics = \lyricmode {
  Ky -- ri -- e e -- lei -- son,
  Ky -- ri -- e e -- lei -- son, e --
  lei -- son, e --
  lei -- son, e --
...
B-XXXVGloriaBassoLyrics = \lyricmode {
  Et in ter -- ra, in
  ter -- ra, ter -- ra pax,
...
B-XXXVDomineBassoLyrics = \lyricmode {
  Do -- mi -- ne, %99
...
B-XXXVQuiTollisBassoLyrics = \lyricmode {
  Qui tol -- %114
  lis %115
  pec -- ca -- ta
  mun -- di:
...
B-XXXVCumSanctoBasso = {
  \relative c {
    ...
    \tempoB-XXXVCumSanctoFuga c,16\trill([ h c8)] e16([\trill d e8)] r8 f4 a8 \noBreak
...
B-XXXVCumSanctoBassoLyrics = \lyricmode {
  Cum San -- cto %162
...
B-XXXVCredoBassoLyrics = \lyricmode {
  Cre -- do in
  u -- num
  De -- um,
  Pa -- trem o -- mni -- po --
...
B-XXXVCrucifixusBassoLyrics = \lyricmode {
  Cru -- ci -- fi -- xus, %72
  cru -- ci --
  fi -- xus e -- ti -- am,
  e -- ti -- am pro %75
...
B-XXXVEtResurrexitBassoLyrics = \lyricmode {
  Et, et re -- sur -- %86
  re -- xit ter -- ti -- a
  di -- e se -- cun --
  dum Scri -- ptu --
