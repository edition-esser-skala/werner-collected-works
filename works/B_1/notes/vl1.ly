...
B-IKyrieViolinoI = {
  \relative c' {
    ...
    a32( h c h) a8 r \tuplet 3/2 8 { c,16 h c f e f a g a }
    ...
    e32( f g f) e8 e32( f g f) e8 e32( f g f) e8
    a8. g32 f e8 \tuplet 3/2 8 { a16 g f } e8 \tuplet 3/2 8 { f16 e d } \sbOff %10
    ...
    r c,16 h c8 e a fis
    d e h g' a, fis'
    h,32(\f c d c) h8 h32( c d c) h8 h32( c d c) h8
    ...
    h32( c d c) h8 r \tuplet 3/2 8 { h,16 a h d c d g f g }
    e32( f g f) e8 r \tuplet 3/2 8 { e16 d e g f g c h c }
    a32( b c \hA b) a8 r \tuplet 3/2 8 { c,16 b? c f e f a g a }
    e32( f g f) e8 r \tuplet 3/2 8 { cis16 h! \hA cis e d e a g a }
    f32( g a g) f8 f32( g a g) f8 f32( g a g) f8 %45
    d32( e f e) d8 r \tuplet 3/2 8 { h16 a h d c d g f g }
    e32( f g f) e8 e32( f g f) e8 e32( f g f) e8
    a8. g32 f e8 \tuplet 3/2 8 { a16 g f } e8 \tuplet 3/2 8 { f16 e d } \sbOff
    e32( f g f) e8 e32( f g f) e8 e32( f g f) e8
    a8 f d4 g \noBreak %50
    e2 r4\fermata \bar "||"
    \key a \minor \time 4/4 \tempoB-IChriste \newSpacingSection
      a,8.\fE c16 \appoggiatura c h8. d16 c8 a16 h c4~ \noBreak
    c16 d32 e f16 a, h4~ h16 c32 d e16 gis, a4~
    a16 h32 c d16 fis, gis8. h16 h( a) a( c) c( h) h( d)
    d( c) c( e) e( d) d( c) c( b) b( a) a( gis) a( h?) %55
    e, gis h d gis e h' d, c64[ h a16.] f64 e d16. c32 h a16 h8\trill
    a4 r r8 e''4\p g!8
    a g16 f e d c h c4 r
    r8 f d-\critnote h' r e, c a'
    r d, h gis' e c r4 %60
    r16 e,\f gis h e8. d32 cis d4 r
    ...
    g64 fis e16. c64[ h a16.] g32 fis e16 \hA fis8\trill e4 r
    r16 e gis h e a, gis d' c8 a r4
    r e'8.\trill\p f32 g a8 f d8.\trill e32 f
    g8 e c8.\trill d32 e f8 d h16. h'32 \tuplet 3/2 8 { h16[ a h] } %70
    e,4 r r2
    r16 e,\f a c c( h) h( d) d( c) c( e) e( d) d( c)
    \slurDashed c( b) b( a) a( gis) a( h?) \slurSolid e, gis h d gis d h' d, \noBreak
    c64 h a16. f64[ e d16.] c32 h a16 h8\trill a4 r\fermata \bar "||"
    \key c \major \time 4/4 \tempoB-IKyrieFuga
      R1*9 %83
    g'4.\fE g8 a4.\trill g16 a
    h4.\trill a16 h c d e c a h c a %85
    h c d h g a h g c d c h a4\trillE
    g c4.\trill h16 c d4~\trill
    d8 c16 d e8 c4 a d8
    h g4 g fis16 e \hA fis4\trillE
    g r r2 %90
