...
B-IKyrieViolinoII = {
  \relative c' {
    ...
    e16 d e8 r c' a c
    h c h g' a, fis'
    g,32(\f a h a) g8 g32( a h a) g8 g32( a h a) g8
    g a h \tuplet 3/2 8 { c16 h a } g8 \tuplet 3/2 8 { a16 g fis }
    g4 r r %25
    r8 fis16\p e \hA fis8 a d fis
    h, g r4 r
    ...
    e c r4 r
    r8 c' d, c' g, h'
    c,\f c'~ \sbOn \tuplet 3/2 8 { c16 h c g f g c h c e^\critnote d e } %40
    g32( a h a) g8 r \tuplet 3/2 8 { d,16 c d g f g h a h }
    c32( d e d) c8 r \tuplet 3/2 8 { g16 f g c h c e d e }
    f32( g a g) f8 r \tuplet 3/2 8 { a,16 g a c h c f e f }
    ...
    r8 h' a h e,4 r
    r2 a8.\trill\p h32 c d8 h
    g8.\trill a32 h c8 a f h4 gis16 h %70
    a8 a r4 r2
    r8 c,\f e16( gis) gis( h) e,8. h'16 a8 g
    f e d c h4 r8 gis' \noBreak
    a64[ h c16.] f,64[ e d16.] c32 h a16 h8\trill a4 r\fermata \bar "||"
    ...
    g4.\trillE f16 g a8 f4 d16 f
    g8 e4 c16 d e4 d
    d c8 c d4.\trill c16 d %90
    e8 d16 e f4. e16 d e4\trill
    f8 c f e16 f d8.\trillE c32 d e16 f g e
    c8 f d16-\critnote e f8 g c, c c
    a d4 d8 g,4 r
    r2 r4 r8 \once \tieDashed c~ %95
    c c d8.\trillE c32 d e16 f g e c h a c
    f g a f d c h d g a h g e d c h
    a-\critnote h c8 d \once \tieDashed g~ g fis16 e \hA fis4\trill
