...
A-XIXBChorusBasso = {
  \relative c {
    ...
    a([ e)] c([ a)] e'8. e16 e4
    a8 a d, d g([ d)] h([ g)]
    d' d r h' a g16([ fis)] e8 d16([ c)]
    h4 h8 c d4( h8[ g]
    d'2) g, %15
    \tempoA-XIXBChorusB R1*5 %20
    d'2 h'8 h a g
    fis([ g)] fis([ e)] d([ e)] d([ c)]
    h([ c h a)] g([ g')] fis([ e)]
    d4 r r2
...
A-XIXBChorusBassoLyrics = \lyricmode {
  So ſey dir Dank ge --
  ...
  Auch Ja -- hel dir ſey %21
  Lob ge -- ſagt, ge --
  ſa -- gt, ge --
  ſagt

  dem Hoch -- muth biſt zum %27
  Sinn -- bild wor -- den,
  wor -- den,
  %30
  dem
  Hoch -- muth biſt zum Sinn -- bild
  wor -- _ _
  den
  %35
  auf wel -- che Arth Gott je -- ne
  ſchlagt und auch in
