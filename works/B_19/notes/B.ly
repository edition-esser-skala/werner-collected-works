...
B-XIXSanctusBassoLyrics = \lyricmode {
  San -- _ _
  _ _ _
  _ _ _ ctus, san --
  ctus,
...
B-XIXAgnusBasso = {
  \relative c {
    ...
    d, r r8 f4 f8
    e4 dis e2
    a,4 r r8 \mvTr f'4\pE^\solo a8
    c([ a)] f a d, d r f
    h, h h4 c r8 g' %10
    cis, cis cis4 d8 d([ f)] a
    b,!([ b')] g([ b)] a[ cis, d b]
    g4 a d r
    r8 \mvTr d4\fE^\tutti d8 a4 a
    r8 d b' g fis4( g) %15
    d r r8 g es c
    f!4 d8 d g2 \noBreak
    f r\fermata \bar "||"
    \tempoB-XIXDona R1 \noBreak
    \mvDl d'8([\fE^\tutti a f d)] a'4 r %20
    R1
    \mvTr a4.\fE^\tutti f8 d4( e)
    a, r r2
    R1
    f'4. c8 f16([ e f8)] f, r %25
    R1
    a'4. e8 a4. e8
    a([ e c a)] e'4 e(
    fis gis) a r
...
B-XIXAgnusBassoLyrics = \lyricmode {
  A -- gnus
  De -- i,
  pec -- ca -- ta mun --
  di, pec -- ca --
