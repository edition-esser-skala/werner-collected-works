...
XXXVIIIOrgano = {
  \relative c {
    ...
    g'8 g, r4 r2
    \clef treble \tempoXXXVIIIb << { \mvTr h''8\pE-\solo h h h } \\ { gis gis gis gis } >> \clef "treble_8" dis dis dis dis
    ...
    g4 e8 c g2 \noBreak
    c r\fermata \bar "||" %25
    \tempoXXXVIIId \mvTr a'2\pE-\soloE g \noBreak
    f fis~
    fis d
    h! c
    cis cis %30
